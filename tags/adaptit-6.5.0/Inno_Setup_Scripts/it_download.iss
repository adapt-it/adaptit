...
// Graphical Installer
procedure itd_SetFontsColor(Color: PAnsiChar);
  external 'itd_SetFontsColor@files:itdownload.dll stdcall';

procedure itd_SetInnerPicture(Image: PAnsiChar);
  external 'itd_SetInnerPicture@files:itdownload.dll stdcall';
