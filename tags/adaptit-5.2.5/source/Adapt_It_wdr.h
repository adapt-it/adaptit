...
const int ID_FILE_PACK_DOC = 513;
const int ID_FILE_UNPACK_DOC = 514;
const int ID_MENU = 515;
const int ID_FILE_STARTUP_WIZARD = 516;
const int ID_FILE_CLOSEKB = 517;
const int ID_FILE_CHANGEFOLDER = 518;
const int ID_FILE_SAVEKB = 519;
const int ID_FILE_BACKUP_KB = 520;
const int ID_FILE_RESTORE_KB = 521;
...
const int ID_EXPORT_IMPORT_MENU = 552;
const int ID_FILE_EXPORT_SOURCE = 553;
const int ID_FILE_EXPORT = 554;
const int ID_FILE_EXPORT_TO_RTF = 555;
const int ID_EXPORT_GLOSSES = 556;
const int ID_EXPORT_FREE_TRANS = 557;
const int ID_FILE_EXPORT_KB = 558;
const int ID_IMPORT_TO_KB = 559;
const int ID_ADVANCED_MENU = 560;
const int ID_ADVANCED_ENABLEGLOSSING = 561;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 562;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 563;
const int ID_ADVANCED_DELAY = 564;
const int ID_ADVANCED_BOOKMODE = 565;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 566;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 567;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 568;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 569;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 570;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 571;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 572;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 573;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 574;
const int ID_LAYOUT_MENU = 575;
const int ID_ALIGNMENT = 576;
const int ID_HELP_MENU = 577;
const int ID_ONLINE_HELP = 578;
const int ID_USER_FORUM = 579;
const int ID_HELP_USE_TOOLTIPS = 580;
const int ID_ADMINISTRATOR_MENU = 581;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 582;
const int ID_LOCK_CUSTOM_LOCATION = 583;
const int ID_UNLOCK_CUSTOM_LOCATION = 584;
const int ID_LOCAL_WORK_FOLDER_MENU = 585;
const int ID_SET_PASSWORD_MENU = 586;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 587;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_CREATE_NOTE = 588;
const int ID_BUTTON_PREV_NOTE = 589;
const int ID_BUTTON_NEXT_NOTE = 590;
const int ID_BUTTON_DELETE_ALL_NOTES = 591;
const int ID_BUTTON_RESPECTING_BDRY = 592;
const int ID_BUTTON_SHOWING_PUNCT = 593;
const int ID_BUTTON_TO_END = 594;
const int ID_BUTTON_TO_START = 595;
const int ID_BUTTON_STEP_DOWN = 596;
const int ID_BUTTON_STEP_UP = 597;
const int ID_BUTTON_BACK = 598;
const int ID_BUTTON_MERGE = 599;
const int ID_BUTTON_RETRANSLATION = 600;
const int ID_BUTTON_EDIT_RETRANSLATION = 601;
const int ID_REMOVE_RETRANSLATION = 602;
const int ID_BUTTON_NULL_SRC = 603;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 604;
const int ID_BUTTON_CHOOSE_TRANSLATION = 605;
const int ID_SHOWING_ALL = 606;
const int ID_BUTTON_EARLIER_TRANSLATION = 607;
const int ID_BUTTON_NO_PUNCT_COPY = 608;
...
const int ID_BITMAP_FOLDERAI = 609;
const int ID_BITMAP_FILEAI = 610;
const int ID_BITMAP_EMPTY_FOLDER = 611;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 612;
const int ID_BUTTON_HIDING_PUNCT = 613;
const int ID_SHOWING_TGT = 614;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 615;
