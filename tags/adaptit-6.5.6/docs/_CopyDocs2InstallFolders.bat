...
xcopy "GuesserExplanation.htm" "..\setup Regular\" /Y
...
xcopy "GuesserExplanation.htm" "..\setup Regular - No Html Help\" /Y
...
xcopy "GuesserExplanation.htm" "..\setup Regular Documentation Only\" /Y
