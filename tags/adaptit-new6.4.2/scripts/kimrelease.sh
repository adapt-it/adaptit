#!/bin/bash
# kimrelease-sh -- Downloads and creates release pacakges of AdaptIt
...
#
#  MODIFIED for special new6.4.2 release 2013-06-25
#
...
# HACK FIXME!
echo DEBUG1: RELEASE was $RELEASE
RELEASE=${RELEASE/new/}
echo DEBUG2: RELEASE is now $RELEASE
