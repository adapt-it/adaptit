...
/// The Thread_UploadToKBServer is a thread class for uploading a single new kbserver entry
/// for eventual sharing; it decouples the upload from the user's normal adapting work, due
/// to high network latency causing unacceptable delays in the responsiveness of the GUI
/// for the interlinear layout.
