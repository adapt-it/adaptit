...
const int ID_FILE_MENU = 618;
const int ID_SAVE_AS = 619;
const int ID_FILE_PACK_DOC = 620;
const int ID_FILE_UNPACK_DOC = 621;
const int ID_MENU = 622;
const int ID_FILE_STARTUP_WIZARD = 623;
const int ID_FILE_CLOSEKB = 624;
const int ID_FILE_CHANGEFOLDER = 625;
const int ID_FILE_SAVEKB = 626;
const int ID_FILE_BACKUP_KB = 627;
const int ID_FILE_RESTORE_KB = 628;
const int ID_EDIT_MENU = 629;
const int ID_EDIT_CUT = 630;
const int ID_EDIT_COPY = 631;
const int ID_EDIT_PASTE = 632;
const int ID_GO_TO = 633;
const int ID_EDIT_SOURCE_TEXT = 634;
const int ID_EDIT_CONSISTENCY_CHECK = 635;
const int ID_EDIT_MOVE_NOTE_FORWARD = 636;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 637;
const int ID_VIEW_MENU = 638;
const int ID_VIEW_TOOLBAR = 639;
const int ID_VIEW_STATUS_BAR = 640;
const int ID_VIEW_COMPOSE_BAR = 641;
const int ID_COPY_SOURCE = 642;
const int ID_MARKER_WRAPS_STRIP = 643;
const int ID_UNITS = 644;
const int ID_CHANGE_INTERFACE_LANGUAGE = 645;
const int ID_VIEW_SHOW_ADMIN_MENU = 646;
const int ID_TOOLS_MENU = 647;
const int ID_TOOLS_DEFINE_CC = 648;
const int ID_UNLOAD_CC_TABLES = 649;
const int ID_USE_CC = 650;
const int ID_ACCEPT_CHANGES = 651;
const int ID_TOOLS_DEFINE_SILCONVERTER = 652;
const int ID_USE_SILCONVERTER = 653;
const int ID_TOOLS_KB_EDITOR = 654;
const int ID_TOOLS_AUTO_CAPITALIZATION = 655;
const int ID_RETRANS_REPORT = 656;
const int ID_TOOLS_SPLIT_DOC = 657;
const int ID_TOOLS_JOIN_DOCS = 658;
const int ID_TOOLS_MOVE_DOC = 659;
const int ID_EXPORT_IMPORT_MENU = 660;
const int ID_FILE_EXPORT_SOURCE = 661;
const int ID_FILE_EXPORT = 662;
const int ID_FILE_EXPORT_TO_RTF = 663;
const int ID_EXPORT_GLOSSES = 664;
const int ID_EXPORT_FREE_TRANS = 665;
const int ID_FILE_EXPORT_KB = 666;
const int ID_IMPORT_TO_KB = 667;
const int ID_MENU_IMPORT_EDITED_SOURCE_TEXT = 668;
const int ID_ADVANCED_MENU = 669;
const int ID_ADVANCED_SEE_GLOSSES = 670;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 671;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 672;
const int ID_ADVANCED_DELAY = 673;
const int ID_ADVANCED_BOOKMODE = 674;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 675;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 676;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 677;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 678;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 679;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 680;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 681;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 682;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 683;
const int ID_LAYOUT_MENU = 684;
const int ID_ALIGNMENT = 685;
const int ID_HELP_MENU = 686;
const int ID_ONLINE_HELP = 687;
const int ID_REPORT_A_PROBLEM = 688;
const int ID_GIVE_FEEDBACK = 689;
const int ID_HELP_USE_TOOLTIPS = 690;
const int ID_ADMINISTRATOR_MENU = 691;
const int ID_SETUP_EDITOR_COLLABORATION = 692;
const int ID_EDIT_USER_MENU_SETTINGS_PROFILE = 693;
const int ID_ASSIGN_LOCATIONS_FOR_INPUTS_OUTPUTS = 694;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 695;
const int ID_SET_PASSWORD_MENU = 696;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 697;
const int ID_LOCK_CUSTOM_LOCATION = 698;
const int ID_UNLOCK_CUSTOM_LOCATION = 699;
const int ID_LOCAL_WORK_FOLDER_MENU = 700;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_GUESSER = 701;
const int ID_BUTTON_CREATE_NOTE = 702;
const int ID_BUTTON_PREV_NOTE = 703;
const int ID_BUTTON_NEXT_NOTE = 704;
const int ID_BUTTON_DELETE_ALL_NOTES = 705;
const int ID_BUTTON_RESPECTING_BDRY = 706;
const int ID_BUTTON_SHOWING_PUNCT = 707;
const int ID_BUTTON_TO_END = 708;
const int ID_BUTTON_TO_START = 709;
const int ID_BUTTON_STEP_DOWN = 710;
const int ID_BUTTON_STEP_UP = 711;
const int ID_BUTTON_BACK = 712;
const int ID_BUTTON_MERGE = 713;
const int ID_BUTTON_RETRANSLATION = 714;
const int ID_BUTTON_EDIT_RETRANSLATION = 715;
const int ID_REMOVE_RETRANSLATION = 716;
const int ID_BUTTON_NULL_SRC = 717;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 718;
const int ID_BUTTON_CHOOSE_TRANSLATION = 719;
const int ID_SHOWING_ALL = 720;
const int ID_BUTTON_EARLIER_TRANSLATION = 721;
const int ID_BUTTON_NO_PUNCT_COPY = 722;
...
const int ID_BITMAP_FOLDERAI = 723;
const int ID_BITMAP_FILEAI = 724;
const int ID_BITMAP_EMPTY_FOLDER = 725;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 726;
const int ID_BUTTON_HIDING_PUNCT = 727;
const int ID_SHOWING_TGT = 728;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 729;
