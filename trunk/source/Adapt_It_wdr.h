...
const int ID_BUTTON_ACCEPT_EDIT = 511;
...
const int ID_FILE_MENU = 513;
const int ID_FILE_PACK_DOC = 514;
const int ID_FILE_UNPACK_DOC = 515;
const int ID_MENU = 516;
const int ID_FILE_STARTUP_WIZARD = 517;
const int ID_FILE_CLOSEKB = 518;
const int ID_FILE_CHANGEFOLDER = 519;
const int ID_FILE_SAVEKB = 520;
const int ID_FILE_BACKUP_KB = 521;
const int ID_FILE_RESTORE_KB = 522;
const int ID_EDIT_MENU = 523;
const int ID_EDIT_CUT = 524;
const int ID_EDIT_COPY = 525;
const int ID_EDIT_PASTE = 526;
const int ID_GO_TO = 527;
const int ID_EDIT_SOURCE_TEXT = 528;
const int ID_EDIT_CONSISTENCY_CHECK = 529;
const int ID_EDIT_MOVE_NOTE_FORWARD = 530;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 531;
const int ID_VIEW_MENU = 532;
const int ID_VIEW_TOOLBAR = 533;
const int ID_VIEW_STATUS_BAR = 534;
const int ID_VIEW_COMPOSE_BAR = 535;
const int ID_COPY_SOURCE = 536;
const int ID_MARKER_WRAPS_STRIP = 537;
const int ID_UNITS = 538;
const int ID_CHANGE_INTERFACE_LANGUAGE = 539;
const int ID_TOOLS_MENU = 540;
const int ID_TOOLS_DEFINE_CC = 541;
const int ID_UNLOAD_CC_TABLES = 542;
const int ID_USE_CC = 543;
const int ID_ACCEPT_CHANGES = 544;
const int ID_TOOLS_DEFINE_SILCONVERTER = 545;
const int ID_USE_SILCONVERTER = 546;
const int ID_TOOLS_KB_EDITOR = 547;
const int ID_TOOLS_AUTO_CAPITALIZATION = 548;
const int ID_RETRANS_REPORT = 549;
const int ID_TOOLS_SPLIT_DOC = 550;
const int ID_TOOLS_JOIN_DOCS = 551;
const int ID_TOOLS_MOVE_DOC = 552;
const int ID_EXPORT_IMPORT_MENU = 553;
const int ID_FILE_EXPORT_SOURCE = 554;
const int ID_FILE_EXPORT = 555;
const int ID_FILE_EXPORT_TO_RTF = 556;
const int ID_EXPORT_GLOSSES = 557;
const int ID_EXPORT_FREE_TRANS = 558;
const int ID_FILE_EXPORT_KB = 559;
const int ID_IMPORT_TO_KB = 560;
const int ID_ADVANCED_MENU = 561;
const int ID_ADVANCED_ENABLEGLOSSING = 562;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 563;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 564;
const int ID_ADVANCED_DELAY = 565;
const int ID_ADVANCED_BOOKMODE = 566;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 567;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 568;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 569;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 570;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 571;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 572;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 573;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 574;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 575;
const int ID_LAYOUT_MENU = 576;
const int ID_ALIGNMENT = 577;
const int ID_HELP_MENU = 578;
const int ID_ONLINE_HELP = 579;
const int ID_USER_FORUM = 580;
const int ID_HELP_USE_TOOLTIPS = 581;
const int ID_ADMINISTRATOR_MENU = 582;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 583;
const int ID_LOCK_CUSTOM_LOCATION = 584;
const int ID_UNLOCK_CUSTOM_LOCATION = 585;
const int ID_LOCAL_WORK_FOLDER_MENU = 586;
const int ID_SET_PASSWORD_MENU = 587;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 588;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_CREATE_NOTE = 589;
const int ID_BUTTON_PREV_NOTE = 590;
const int ID_BUTTON_NEXT_NOTE = 591;
const int ID_BUTTON_DELETE_ALL_NOTES = 592;
const int ID_BUTTON_RESPECTING_BDRY = 593;
const int ID_BUTTON_SHOWING_PUNCT = 594;
const int ID_BUTTON_TO_END = 595;
const int ID_BUTTON_TO_START = 596;
const int ID_BUTTON_STEP_DOWN = 597;
const int ID_BUTTON_STEP_UP = 598;
const int ID_BUTTON_BACK = 599;
const int ID_BUTTON_MERGE = 600;
const int ID_BUTTON_RETRANSLATION = 601;
const int ID_BUTTON_EDIT_RETRANSLATION = 602;
const int ID_REMOVE_RETRANSLATION = 603;
const int ID_BUTTON_NULL_SRC = 604;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 605;
const int ID_BUTTON_CHOOSE_TRANSLATION = 606;
const int ID_SHOWING_ALL = 607;
const int ID_BUTTON_EARLIER_TRANSLATION = 608;
const int ID_BUTTON_NO_PUNCT_COPY = 609;
...
const int ID_BITMAP_FOLDERAI = 610;
const int ID_BITMAP_FILEAI = 611;
const int ID_BITMAP_EMPTY_FOLDER = 612;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 613;
const int ID_BUTTON_HIDING_PUNCT = 614;
const int ID_SHOWING_TGT = 615;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 616;
