...
const int ID_TEXT_SOURCE_FOLDER_PATH = 478;
const int ID_TEXTCTRL_SOURCE_PATH = 479;
...
const int ID_LISTCTRL_DESTINATION_CONTENTS = 484;
const int ID_BUTTON_MOVE_FOLDER = 485;
const int ID_BUTTON_MOVE_FILES = 486;
const int ID_BUTTON_COPY_FOLDER = 487;
const int ID_BUTTON_COPY_FILES = 488;
wxSizer *MoveOrCopyFilesOrFoldersFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

// Declare menubar functions

const int ID_FILE_MENU = 489;
...
const int ID_EDIT_MENU = 499;
const int ID_EDIT_CUT = 500;
const int ID_EDIT_COPY = 501;
const int ID_EDIT_PASTE = 502;
const int ID_GO_TO = 503;
const int ID_EDIT_SOURCE_TEXT = 504;
const int ID_EDIT_CONSISTENCY_CHECK = 505;
const int ID_EDIT_MOVE_NOTE_FORWARD = 506;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 507;
const int ID_VIEW_MENU = 508;
const int ID_VIEW_TOOLBAR = 509;
const int ID_VIEW_STATUS_BAR = 510;
const int ID_VIEW_COMPOSE_BAR = 511;
const int ID_COPY_SOURCE = 512;
const int ID_MARKER_WRAPS_STRIP = 513;
const int ID_UNITS = 514;
const int ID_CHANGE_INTERFACE_LANGUAGE = 515;
const int ID_TOOLS_MENU = 516;
const int ID_TOOLS_DEFINE_CC = 517;
const int ID_UNLOAD_CC_TABLES = 518;
const int ID_USE_CC = 519;
const int ID_ACCEPT_CHANGES = 520;
const int ID_TOOLS_DEFINE_SILCONVERTER = 521;
const int ID_USE_SILCONVERTER = 522;
const int ID_TOOLS_KB_EDITOR = 523;
const int ID_TOOLS_AUTO_CAPITALIZATION = 524;
const int ID_RETRANS_REPORT = 525;
const int ID_TOOLS_SPLIT_DOC = 526;
const int ID_TOOLS_JOIN_DOCS = 527;
const int ID_TOOLS_MOVE_DOC = 528;
const int ID_EXPORT_IMPORT_MENU = 529;
const int ID_FILE_EXPORT_SOURCE = 530;
const int ID_FILE_EXPORT = 531;
const int ID_FILE_EXPORT_TO_RTF = 532;
const int ID_EXPORT_GLOSSES = 533;
const int ID_EXPORT_FREE_TRANS = 534;
const int ID_FILE_EXPORT_KB = 535;
const int ID_IMPORT_TO_KB = 536;
const int ID_ADVANCED_MENU = 537;
const int ID_ADVANCED_ENABLEGLOSSING = 538;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 539;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 540;
const int ID_ADVANCED_DELAY = 541;
const int ID_ADVANCED_BOOKMODE = 542;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 543;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 544;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 545;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 546;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 547;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 548;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 549;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 550;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 551;
const int ID_LAYOUT_MENU = 552;
const int ID_ALIGNMENT = 553;
const int ID_HELP_MENU = 554;
const int ID_ONLINE_HELP = 555;
const int ID_USER_FORUM = 556;
const int ID_HELP_USE_TOOLTIPS = 557;
const int ID_ADMINISTRATOR_MENU = 558;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 559;
const int ID_LOCK_CUSTOM_LOCATION = 560;
const int ID_UNLOCK_CUSTOM_LOCATION = 561;
const int ID_LOCAL_WORK_FOLDER_MENU = 562;
const int ID_SET_PASSWORD_MENU = 563;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 564;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_CREATE_NOTE = 565;
const int ID_BUTTON_PREV_NOTE = 566;
const int ID_BUTTON_NEXT_NOTE = 567;
const int ID_BUTTON_DELETE_ALL_NOTES = 568;
const int ID_BUTTON_RESPECTING_BDRY = 569;
const int ID_BUTTON_SHOWING_PUNCT = 570;
const int ID_BUTTON_TO_END = 571;
const int ID_BUTTON_TO_START = 572;
const int ID_BUTTON_STEP_DOWN = 573;
const int ID_BUTTON_STEP_UP = 574;
const int ID_BUTTON_BACK = 575;
const int ID_BUTTON_MERGE = 576;
const int ID_BUTTON_RESTORE = 577;
const int ID_BUTTON_RETRANSLATION = 578;
const int ID_BUTTON_EDIT_RETRANSLATION = 579;
const int ID_REMOVE_RETRANSLATION = 580;
const int ID_BUTTON_NULL_SRC = 581;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 582;
const int ID_BUTTON_CHOOSE_TRANSLATION = 583;
const int ID_SHOWING_ALL = 584;
const int ID_BUTTON_EARLIER_TRANSLATION = 585;
const int ID_BUTTON_NO_PUNCT_COPY = 586;
...
const int ID_BITMAP_FOLDERAI = 587;
const int ID_BITMAP_FILEAI = 588;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 589;
const int ID_BUTTON_HIDING_PUNCT = 590;
const int ID_SHOWING_TGT = 591;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 592;
