...
const int ID_EXPORT_IMPORT_MENU = 530;
const int ID_FILE_EXPORT_SOURCE = 531;
const int ID_FILE_EXPORT = 532;
const int ID_FILE_EXPORT_TO_RTF = 533;
const int ID_EXPORT_GLOSSES = 534;
const int ID_EXPORT_FREE_TRANS = 535;
const int ID_FILE_EXPORT_KB = 536;
const int ID_IMPORT_TO_KB = 537;
...
const int ID_ADMINISTRATOR_MENU = 559;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 560;
const int ID_LOCK_CUSTOM_LOCATION = 561;
const int ID_UNLOCK_CUSTOM_LOCATION = 562;
const int ID_LOCAL_WORK_FOLDER_MENU = 563;
const int ID_SET_PASSWORD_MENU = 564;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 565;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_CREATE_NOTE = 566;
const int ID_BUTTON_PREV_NOTE = 567;
const int ID_BUTTON_NEXT_NOTE = 568;
const int ID_BUTTON_DELETE_ALL_NOTES = 569;
const int ID_BUTTON_RESPECTING_BDRY = 570;
const int ID_BUTTON_SHOWING_PUNCT = 571;
const int ID_BUTTON_TO_END = 572;
const int ID_BUTTON_TO_START = 573;
const int ID_BUTTON_STEP_DOWN = 574;
const int ID_BUTTON_STEP_UP = 575;
const int ID_BUTTON_BACK = 576;
const int ID_BUTTON_MERGE = 577;
const int ID_BUTTON_RESTORE = 578;
const int ID_BUTTON_RETRANSLATION = 579;
const int ID_BUTTON_EDIT_RETRANSLATION = 580;
const int ID_REMOVE_RETRANSLATION = 581;
const int ID_BUTTON_NULL_SRC = 582;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 583;
const int ID_BUTTON_CHOOSE_TRANSLATION = 584;
const int ID_SHOWING_ALL = 585;
const int ID_BUTTON_EARLIER_TRANSLATION = 586;
const int ID_BUTTON_NO_PUNCT_COPY = 587;
