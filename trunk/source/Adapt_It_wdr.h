...
const int ID_TEXTCTRL_AS_STATIC_TOP_NOTE = 574;
const int ID_TEXT_STATIC_LIST_OF_PROJECTS = 575;
const int IDC_LIST_OF_COLLAB_PROJECTS = 576;
const int ID_TEXTCTRL_AS_STATIC_IMPORTANT_BOTTOM_NOTE = 577;
const int ID_RADIOBOX_COLLABORATION_ON_OFF = 578;
const int ID_TEXTCTRL_AS_STATIC_SELECTED_SRC_PROJ = 579;
const int ID_BUTTON_SELECT_FROM_LIST_SOURCE_PROJ = 580;
const int ID_TEXTCTRL_AS_STATIC_SELECTED_TGT_PROJ = 581;
const int ID_BUTTON_SELECT_FROM_LIST_TARGET_PROJ = 582;
const int ID_TEXTCTRL_AS_STATIC_SELECTED_FREE_TRANS_PROJ = 583;
const int ID_BUTTON_SELECT_FROM_LIST_FREE_TRANS_PROJ = 584;
wxSizer *SetupEditorCollaborationFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_COMBO_SOURCE_PROJECT_NAME = 585;
const int ID_COMBO_DESTINATION_PROJECT_NAME = 586;
const int ID_COMBO_FREE_TRANS_PROJECT_NAME = 587;
const int ID_BUTTON_NO_FREE_TRANS = 588;
const int ID_RADIOBOX_WHOLE_BOOK_OR_CHAPTER = 589;
const int ID_LISTBOX_BOOK_NAMES = 590;
const int ID_TEXT_SELECT_A_CHAPTER = 591;
const int ID_LISTCTRL_CHAPTER_NUMBER_AND_STATUS = 592;
const int ID_TEXTCTRL_AS_STATIC_NOTE = 593;
wxSizer *GetSourceTextFromEditorDlgFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXTCTRL_SOURCE_TEXT_VERSE = 594;
const int ID_TEXTCTRL_AS_STATIC_INSTRUCTIONS = 595;
const int ID_TEXTCTRL_AS_STATIC_EARLIER_FROM = 596;
const int ID_TEXTCTRL_AS_STATIC_RECENT_FROM = 597;
const int ID_TEXTCTRL_EARLIER_VERSION = 598;
const int ID_TEXTCTRL_RECENT_VERSION = 599;
const int ID_BUTTON_USE_EARLIER = 600;
const int ID_BUTTON_USE_RECENT = 601;
...
const int ID_FILE_MENU = 632;
const int ID_SAVE_AS = 633;
const int ID_FILE_PACK_DOC = 634;
const int ID_FILE_UNPACK_DOC = 635;
const int ID_MENU = 636;
const int ID_FILE_STARTUP_WIZARD = 637;
const int ID_FILE_CLOSEKB = 638;
const int ID_FILE_CHANGEFOLDER = 639;
const int ID_FILE_SAVEKB = 640;
const int ID_FILE_BACKUP_KB = 641;
const int ID_FILE_RESTORE_KB = 642;
const int ID_EDIT_MENU = 643;
const int ID_EDIT_CUT = 644;
const int ID_EDIT_COPY = 645;
const int ID_EDIT_PASTE = 646;
const int ID_GO_TO = 647;
const int ID_EDIT_SOURCE_TEXT = 648;
const int ID_EDIT_CONSISTENCY_CHECK = 649;
const int ID_EDIT_MOVE_NOTE_FORWARD = 650;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 651;
const int ID_VIEW_MENU = 652;
const int ID_VIEW_TOOLBAR = 653;
const int ID_VIEW_STATUS_BAR = 654;
const int ID_VIEW_COMPOSE_BAR = 655;
const int ID_COPY_SOURCE = 656;
const int ID_MARKER_WRAPS_STRIP = 657;
const int ID_UNITS = 658;
const int ID_CHANGE_INTERFACE_LANGUAGE = 659;
const int ID_VIEW_SHOW_ADMIN_MENU = 660;
const int ID_TOOLS_MENU = 661;
const int ID_TOOLS_DEFINE_CC = 662;
const int ID_UNLOAD_CC_TABLES = 663;
const int ID_USE_CC = 664;
const int ID_ACCEPT_CHANGES = 665;
const int ID_TOOLS_DEFINE_SILCONVERTER = 666;
const int ID_USE_SILCONVERTER = 667;
const int ID_TOOLS_KB_EDITOR = 668;
const int ID_TOOLS_AUTO_CAPITALIZATION = 669;
const int ID_RETRANS_REPORT = 670;
const int ID_TOOLS_SPLIT_DOC = 671;
const int ID_TOOLS_JOIN_DOCS = 672;
const int ID_TOOLS_MOVE_DOC = 673;
const int ID_EXPORT_IMPORT_MENU = 674;
const int ID_FILE_EXPORT_SOURCE = 675;
const int ID_FILE_EXPORT = 676;
const int ID_FILE_EXPORT_TO_RTF = 677;
const int ID_EXPORT_GLOSSES = 678;
const int ID_EXPORT_FREE_TRANS = 679;
const int ID_FILE_EXPORT_KB = 680;
const int ID_IMPORT_TO_KB = 681;
const int ID_MENU_IMPORT_EDITED_SOURCE_TEXT = 682;
const int ID_ADVANCED_MENU = 683;
const int ID_ADVANCED_SEE_GLOSSES = 684;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 685;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 686;
const int ID_ADVANCED_DELAY = 687;
const int ID_ADVANCED_BOOKMODE = 688;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 689;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 690;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 691;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 692;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 693;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 694;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 695;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 696;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 697;
const int ID_LAYOUT_MENU = 698;
const int ID_ALIGNMENT = 699;
const int ID_HELP_MENU = 700;
const int ID_ONLINE_HELP = 701;
const int ID_REPORT_A_PROBLEM = 702;
const int ID_GIVE_FEEDBACK = 703;
const int ID_HELP_USE_TOOLTIPS = 704;
const int ID_ADMINISTRATOR_MENU = 705;
const int ID_SETUP_EDITOR_COLLABORATION = 706;
const int ID_EDIT_USER_MENU_SETTINGS_PROFILE = 707;
const int ID_ASSIGN_LOCATIONS_FOR_INPUTS_OUTPUTS = 708;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 709;
const int ID_SET_PASSWORD_MENU = 710;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 711;
const int ID_LOCK_CUSTOM_LOCATION = 712;
const int ID_UNLOCK_CUSTOM_LOCATION = 713;
const int ID_LOCAL_WORK_FOLDER_MENU = 714;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_GUESSER = 715;
const int ID_BUTTON_CREATE_NOTE = 716;
const int ID_BUTTON_PREV_NOTE = 717;
const int ID_BUTTON_NEXT_NOTE = 718;
const int ID_BUTTON_DELETE_ALL_NOTES = 719;
const int ID_BUTTON_RESPECTING_BDRY = 720;
const int ID_BUTTON_SHOWING_PUNCT = 721;
const int ID_BUTTON_TO_END = 722;
const int ID_BUTTON_TO_START = 723;
const int ID_BUTTON_STEP_DOWN = 724;
const int ID_BUTTON_STEP_UP = 725;
const int ID_BUTTON_BACK = 726;
const int ID_BUTTON_MERGE = 727;
const int ID_BUTTON_RETRANSLATION = 728;
const int ID_BUTTON_EDIT_RETRANSLATION = 729;
const int ID_REMOVE_RETRANSLATION = 730;
const int ID_BUTTON_NULL_SRC = 731;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 732;
const int ID_BUTTON_CHOOSE_TRANSLATION = 733;
const int ID_SHOWING_ALL = 734;
const int ID_BUTTON_EARLIER_TRANSLATION = 735;
const int ID_BUTTON_NO_PUNCT_COPY = 736;
...
const int ID_BITMAP_FOLDERAI = 737;
const int ID_BITMAP_FILEAI = 738;
const int ID_BITMAP_EMPTY_FOLDER = 739;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 740;
const int ID_BUTTON_HIDING_PUNCT = 741;
const int ID_SHOWING_TGT = 742;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 743;
