...
const int ID_VIEW_SHOW_ADMIN_MENU = 645;
const int ID_TOOLS_MENU = 646;
const int ID_TOOLS_DEFINE_CC = 647;
const int ID_UNLOAD_CC_TABLES = 648;
const int ID_USE_CC = 649;
const int ID_ACCEPT_CHANGES = 650;
const int ID_TOOLS_DEFINE_SILCONVERTER = 651;
const int ID_USE_SILCONVERTER = 652;
const int ID_TOOLS_KB_EDITOR = 653;
const int ID_TOOLS_AUTO_CAPITALIZATION = 654;
const int ID_RETRANS_REPORT = 655;
const int ID_TOOLS_SPLIT_DOC = 656;
const int ID_TOOLS_JOIN_DOCS = 657;
const int ID_TOOLS_MOVE_DOC = 658;
const int ID_EXPORT_IMPORT_MENU = 659;
const int ID_FILE_EXPORT_SOURCE = 660;
const int ID_FILE_EXPORT = 661;
const int ID_FILE_EXPORT_TO_RTF = 662;
const int ID_EXPORT_GLOSSES = 663;
const int ID_EXPORT_FREE_TRANS = 664;
const int ID_FILE_EXPORT_KB = 665;
const int ID_IMPORT_TO_KB = 666;
const int ID_MENU_IMPORT_EDITED_SOURCE_TEXT = 667;
const int ID_ADVANCED_MENU = 668;
const int ID_ADVANCED_ENABLEGLOSSING = 669;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 670;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 671;
const int ID_ADVANCED_DELAY = 672;
const int ID_ADVANCED_BOOKMODE = 673;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 674;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 675;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 676;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 677;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 678;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 679;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 680;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 681;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 682;
const int ID_LAYOUT_MENU = 683;
const int ID_ALIGNMENT = 684;
const int ID_HELP_MENU = 685;
const int ID_ONLINE_HELP = 686;
const int ID_REPORT_A_PROBLEM = 687;
const int ID_GIVE_FEEDBACK = 688;
const int ID_HELP_USE_TOOLTIPS = 689;
const int ID_ADMINISTRATOR_MENU = 690;
const int ID_SETUP_EDITOR_COLLABORATION = 691;
const int ID_EDIT_USER_MENU_SETTINGS_PROFILE = 692;
const int ID_ASSIGN_LOCATIONS_FOR_INPUTS_OUTPUTS = 693;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 694;
const int ID_SET_PASSWORD_MENU = 695;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 696;
const int ID_LOCK_CUSTOM_LOCATION = 697;
const int ID_UNLOCK_CUSTOM_LOCATION = 698;
const int ID_LOCAL_WORK_FOLDER_MENU = 699;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_GUESSER = 700;
const int ID_BUTTON_CREATE_NOTE = 701;
const int ID_BUTTON_PREV_NOTE = 702;
const int ID_BUTTON_NEXT_NOTE = 703;
const int ID_BUTTON_DELETE_ALL_NOTES = 704;
const int ID_BUTTON_RESPECTING_BDRY = 705;
const int ID_BUTTON_SHOWING_PUNCT = 706;
const int ID_BUTTON_TO_END = 707;
const int ID_BUTTON_TO_START = 708;
const int ID_BUTTON_STEP_DOWN = 709;
const int ID_BUTTON_STEP_UP = 710;
const int ID_BUTTON_BACK = 711;
const int ID_BUTTON_MERGE = 712;
const int ID_BUTTON_RETRANSLATION = 713;
const int ID_BUTTON_EDIT_RETRANSLATION = 714;
const int ID_REMOVE_RETRANSLATION = 715;
const int ID_BUTTON_NULL_SRC = 716;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 717;
const int ID_BUTTON_CHOOSE_TRANSLATION = 718;
const int ID_SHOWING_ALL = 719;
const int ID_BUTTON_EARLIER_TRANSLATION = 720;
const int ID_BUTTON_NO_PUNCT_COPY = 721;
...
const int ID_BITMAP_FOLDERAI = 722;
const int ID_BITMAP_FILEAI = 723;
const int ID_BITMAP_EMPTY_FOLDER = 724;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 725;
const int ID_BUTTON_HIDING_PUNCT = 726;
const int ID_SHOWING_TGT = 727;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 728;
