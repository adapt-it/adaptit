...
const int ID_LINE_1 = 575;
const int ID_TEXT_STATIC_SELECT_WHICH_PROJECTS = 576;
const int ID_TEXT_STATIC_SELECT_THIRD_PROJECT = 577;
const int ID_TEXT_STATIC_SRC_FROM_THIS_PROJECT = 578;
const int ID_TEXTCTRL_AS_STATIC_SELECTED_SRC_PROJ = 579;
const int ID_BUTTON_SELECT_FROM_LIST_SOURCE_PROJ = 580;
const int ID_TEXT_STATIC_TARGET_TO_THIS_PROJECT = 581;
const int ID_TEXTCTRL_AS_STATIC_SELECTED_TGT_PROJ = 582;
const int ID_BUTTON_SELECT_FROM_LIST_TARGET_PROJ = 583;
const int ID_TEXT_STATIC_TO_THIS_FT_PROJECT = 584;
const int ID_TEXTCTRL_AS_STATIC_SELECTED_FREE_TRANS_PROJ = 585;
const int ID_BUTTON_SELECT_FROM_LIST_FREE_TRANS_PROJ = 586;
const int ID_BUTTON_NO_FREE_TRANS = 587;
const int ID_LINE_2 = 588;
const int ID_TEXT_STATIC_SELECT_SUITABLE_AI_PROJECT = 589;
const int ID_COMBO_AI_PROJECTS = 590;
const int ID_RADIOBOX_COLLABORATION_ON_OFF = 591;
extern wxSizer *pNewNamesSizer2;
const int ID_TEXT_ENTER_LANG_NAME = 592;
const int ID_TEXT_AS_STATIC_NEW_AI_PROJ_NAME = 593;
const int ID_TEXT_SRC_NAME_LABEL = 594;
const int ID_TEXTCTRL_SRC_LANG_NAME = 595;
const int ID_TEXT_TGT_NAME_LABEL = 596;
const int ID_TEXTCTRL_TGT_LANG_NAME = 597;
const int ID_TEXTCTRL_NEW_AI_PROJ_NAME = 598;
wxSizer *SetupEditorCollaborationFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_RADIOBOX_WHOLE_BOOK_OR_CHAPTER = 599;
const int ID_TEXT_SRC_PROJ = 600;
const int ID_TEXT_TGT_PROJ = 601;
const int ID_TEXT_FREETRANS_PROJ = 602;
const int ID_LISTBOX_BOOK_NAMES = 603;
const int ID_TEXT_SELECT_A_CHAPTER = 604;
const int ID_LISTCTRL_CHAPTER_NUMBER_AND_STATUS = 605;
const int ID_TEXTCTRL_AS_STATIC_NOTE = 606;
const int ID_BUTTON_CHANGE_PROJECTS = 607;
wxSizer *GetSourceTextFromEditorDlgFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXTCTRL_AS_STATIC_TOP_INFO = 608;
const int ID_CHECKBOX_PROTECT_SOURCE_INPUTS = 609;
const int ID_BUTTON_PRE_LOAD_SOURCE_TEXTS = 610;
const int ID_CHECKBOX_PROTECT_FREETRANS_OUTPUTS = 611;
const int ID_CHECKBOX_PROTECT_FREETRANS_RTF_OUTPUTS = 612;
const int ID_CHECKBOX_PROTECT_GLOSS_OUTPUTS = 613;
const int ID_CHECKBOX_PROTECT_GLOSS_RTF_OUTPUTS = 614;
const int ID_CHECKBOX_PROTECT_SOURCE_OUTPUTS = 615;
const int ID_CHECKBOX_PROTECT_SOURCE_RTF_OUTPUTS = 616;
const int ID_CHECKBOX_PROTECT_TARGET_OUTPUTS = 617;
const int ID_CHECKBOX_PROTECT_TARGET_RTF_OUTPUTS = 618;
const int ID_CHECKBOX_PROTECT_REPORTS_OUTPUTS = 619;
const int ID_CHECKBOX_PROTECT_INTERLINEAR_RTF_OUTPUTS = 620;
...
const int ID_TEXT_DO_NOT_CHANGE_NOTE = 646;
const int ID_COMBO_SOURCE_PROJECT_NAME = 647;
const int ID_COMBO_DESTINATION_PROJECT_NAME = 648;
const int ID_COMBO_FREE_TRANS_PROJECT_NAME = 649;
const int ID_TEXT_USE_DROP_DOWN = 650;
extern wxSizer *pNewNamesSizer;
const int ID_LINE_3 = 651;
wxSizer *SelectCollabProjectsDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXT_SRC = 652;
const int ID_TEXTCTRL_SRC_LANG = 653;
const int ID_TEXT_NOTCHANGED = 654;
const int ID_TEXT_TGT_CODE = 655;
const int ID_LISTBOX_TGT = 656;
const int ID_TEXT_GLOSS_CODE = 657;
const int ID_LISTBOX_GLOSS = 658;
const int ID_TEXTCTRL_TELL = 659;
const int ID_TEXTCTRL_MSG2 = 660;
wxSizer *LiftLangFilterFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

// Declare menubar functions

const int ID_FILE_MENU = 661;
const int ID_SAVE_AS = 662;
const int ID_FILE_PACK_DOC = 663;
const int ID_FILE_UNPACK_DOC = 664;
const int ID_MENU = 665;
const int ID_FILE_STARTUP_WIZARD = 666;
const int ID_FILE_CLOSEKB = 667;
const int ID_FILE_CHANGEFOLDER = 668;
const int ID_FILE_SAVEKB = 669;
const int ID_FILE_BACKUP_KB = 670;
const int ID_FILE_RESTORE_KB = 671;
const int ID_EDIT_MENU = 672;
const int ID_EDIT_CUT = 673;
const int ID_EDIT_COPY = 674;
const int ID_EDIT_PASTE = 675;
const int ID_GO_TO = 676;
const int ID_EDIT_SOURCE_TEXT = 677;
const int ID_EDIT_CONSISTENCY_CHECK = 678;
const int ID_EDIT_MOVE_NOTE_FORWARD = 679;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 680;
const int ID_VIEW_MENU = 681;
const int ID_VIEW_TOOLBAR = 682;
const int ID_VIEW_STATUS_BAR = 683;
const int ID_VIEW_COMPOSE_BAR = 684;
const int ID_COPY_SOURCE = 685;
const int ID_MARKER_WRAPS_STRIP = 686;
const int ID_UNITS = 687;
const int ID_CHANGE_INTERFACE_LANGUAGE = 688;
const int ID_VIEW_SHOW_ADMIN_MENU = 689;
const int ID_TOOLS_MENU = 690;
const int ID_TOOLS_DEFINE_CC = 691;
const int ID_UNLOAD_CC_TABLES = 692;
const int ID_USE_CC = 693;
const int ID_ACCEPT_CHANGES = 694;
const int ID_TOOLS_DEFINE_SILCONVERTER = 695;
const int ID_USE_SILCONVERTER = 696;
const int ID_TOOLS_KB_EDITOR = 697;
const int ID_TOOLS_AUTO_CAPITALIZATION = 698;
const int ID_RETRANS_REPORT = 699;
const int ID_TOOLS_SPLIT_DOC = 700;
const int ID_TOOLS_JOIN_DOCS = 701;
const int ID_TOOLS_MOVE_DOC = 702;
const int ID_EXPORT_IMPORT_MENU = 703;
const int ID_FILE_EXPORT_SOURCE = 704;
const int ID_FILE_EXPORT = 705;
const int ID_FILE_EXPORT_TO_RTF = 706;
const int ID_EXPORT_GLOSSES = 707;
const int ID_EXPORT_FREE_TRANS = 708;
const int ID_FILE_EXPORT_KB = 709;
const int ID_IMPORT_TO_KB = 710;
const int ID_MENU_IMPORT_EDITED_SOURCE_TEXT = 711;
const int ID_ADVANCED_MENU = 712;
const int ID_ADVANCED_SEE_GLOSSES = 713;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 714;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 715;
const int ID_ADVANCED_DELAY = 716;
const int ID_ADVANCED_BOOKMODE = 717;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 718;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 719;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 720;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 721;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 722;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 723;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 724;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 725;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 726;
const int ID_LAYOUT_MENU = 727;
const int ID_ALIGNMENT = 728;
const int ID_HELP_MENU = 729;
const int ID_MENU_AI_QUICK_START = 730;
const int ID_REPORT_A_PROBLEM = 731;
const int ID_GIVE_FEEDBACK = 732;
const int ID_HELP_USE_TOOLTIPS = 733;
const int ID_ADMINISTRATOR_MENU = 734;
const int ID_MENU_HELP_FOR_ADMINISTRATORS = 735;
const int ID_SETUP_EDITOR_COLLABORATION = 736;
const int ID_EDIT_USER_MENU_SETTINGS_PROFILE = 737;
const int ID_ASSIGN_LOCATIONS_FOR_INPUTS_OUTPUTS = 738;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 739;
const int ID_SET_PASSWORD_MENU = 740;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 741;
const int ID_LOCK_CUSTOM_LOCATION = 742;
const int ID_UNLOCK_CUSTOM_LOCATION = 743;
const int ID_LOCAL_WORK_FOLDER_MENU = 744;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_GUESSER = 745;
const int ID_BUTTON_CREATE_NOTE = 746;
const int ID_BUTTON_PREV_NOTE = 747;
const int ID_BUTTON_NEXT_NOTE = 748;
const int ID_BUTTON_DELETE_ALL_NOTES = 749;
const int ID_BUTTON_RESPECTING_BDRY = 750;
const int ID_BUTTON_SHOWING_PUNCT = 751;
const int ID_BUTTON_TO_END = 752;
const int ID_BUTTON_TO_START = 753;
const int ID_BUTTON_STEP_DOWN = 754;
const int ID_BUTTON_STEP_UP = 755;
const int ID_BUTTON_BACK = 756;
const int ID_BUTTON_MERGE = 757;
const int ID_BUTTON_RETRANSLATION = 758;
const int ID_BUTTON_EDIT_RETRANSLATION = 759;
const int ID_REMOVE_RETRANSLATION = 760;
const int ID_BUTTON_NULL_SRC = 761;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 762;
const int ID_BUTTON_CHOOSE_TRANSLATION = 763;
const int ID_SHOWING_ALL = 764;
const int ID_BUTTON_EARLIER_TRANSLATION = 765;
const int ID_BUTTON_NO_PUNCT_COPY = 766;
...
const int ID_BITMAP_FOLDERAI = 767;
const int ID_BITMAP_FILEAI = 768;
const int ID_BITMAP_EMPTY_FOLDER = 769;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 770;
const int ID_BUTTON_HIDING_PUNCT = 771;
const int ID_SHOWING_TGT = 772;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 773;
