...
const int ID_BUTTON_SELECT_ALL_CHECKBOXES = 613;
wxSizer *AssignLocationsForInputsOutputsFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

// Declare menubar functions

const int ID_FILE_MENU = 614;
const int ID_SAVE_AS = 615;
const int ID_FILE_PACK_DOC = 616;
const int ID_FILE_UNPACK_DOC = 617;
const int ID_MENU = 618;
const int ID_FILE_STARTUP_WIZARD = 619;
const int ID_FILE_CLOSEKB = 620;
const int ID_FILE_CHANGEFOLDER = 621;
const int ID_FILE_SAVEKB = 622;
const int ID_FILE_BACKUP_KB = 623;
const int ID_FILE_RESTORE_KB = 624;
const int ID_EDIT_MENU = 625;
const int ID_EDIT_CUT = 626;
const int ID_EDIT_COPY = 627;
const int ID_EDIT_PASTE = 628;
const int ID_GO_TO = 629;
const int ID_EDIT_SOURCE_TEXT = 630;
const int ID_EDIT_CONSISTENCY_CHECK = 631;
const int ID_EDIT_MOVE_NOTE_FORWARD = 632;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 633;
const int ID_VIEW_MENU = 634;
const int ID_VIEW_TOOLBAR = 635;
const int ID_VIEW_STATUS_BAR = 636;
const int ID_VIEW_COMPOSE_BAR = 637;
const int ID_COPY_SOURCE = 638;
const int ID_MARKER_WRAPS_STRIP = 639;
const int ID_UNITS = 640;
const int ID_CHANGE_INTERFACE_LANGUAGE = 641;
const int ID_TOOLS_MENU = 642;
const int ID_TOOLS_DEFINE_CC = 643;
const int ID_UNLOAD_CC_TABLES = 644;
const int ID_USE_CC = 645;
const int ID_ACCEPT_CHANGES = 646;
const int ID_TOOLS_DEFINE_SILCONVERTER = 647;
const int ID_USE_SILCONVERTER = 648;
const int ID_TOOLS_KB_EDITOR = 649;
const int ID_TOOLS_AUTO_CAPITALIZATION = 650;
const int ID_RETRANS_REPORT = 651;
const int ID_TOOLS_SPLIT_DOC = 652;
const int ID_TOOLS_JOIN_DOCS = 653;
const int ID_TOOLS_MOVE_DOC = 654;
const int ID_EXPORT_IMPORT_MENU = 655;
const int ID_FILE_EXPORT_SOURCE = 656;
const int ID_FILE_EXPORT = 657;
const int ID_FILE_EXPORT_TO_RTF = 658;
const int ID_EXPORT_GLOSSES = 659;
const int ID_EXPORT_FREE_TRANS = 660;
const int ID_FILE_EXPORT_KB = 661;
const int ID_IMPORT_TO_KB = 662;
const int ID_MENU_IMPORT_EDITED_SOURCE_TEXT = 663;
const int ID_ADVANCED_MENU = 664;
const int ID_ADVANCED_ENABLEGLOSSING = 665;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 666;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 667;
const int ID_ADVANCED_DELAY = 668;
const int ID_ADVANCED_BOOKMODE = 669;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 670;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 671;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 672;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 673;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 674;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 675;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 676;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 677;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 678;
const int ID_LAYOUT_MENU = 679;
const int ID_ALIGNMENT = 680;
const int ID_HELP_MENU = 681;
const int ID_ONLINE_HELP = 682;
const int ID_REPORT_A_PROBLEM = 683;
const int ID_GIVE_FEEDBACK = 684;
const int ID_HELP_USE_TOOLTIPS = 685;
const int ID_ADMINISTRATOR_MENU = 686;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 687;
const int ID_LOCK_CUSTOM_LOCATION = 688;
const int ID_UNLOCK_CUSTOM_LOCATION = 689;
const int ID_LOCAL_WORK_FOLDER_MENU = 690;
const int ID_SET_PASSWORD_MENU = 691;
const int ID_SETUP_EDITOR_COLLABORATION = 692;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 693;
const int ID_ASSIGN_LOCATIONS_FOR_INPUTS_OUTPUTS = 694;
const int ID_EDIT_USER_MENU_SETTINGS_PROFILE = 695;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_GUESSER = 696;
const int ID_BUTTON_CREATE_NOTE = 697;
const int ID_BUTTON_PREV_NOTE = 698;
const int ID_BUTTON_NEXT_NOTE = 699;
const int ID_BUTTON_DELETE_ALL_NOTES = 700;
const int ID_BUTTON_RESPECTING_BDRY = 701;
const int ID_BUTTON_SHOWING_PUNCT = 702;
const int ID_BUTTON_TO_END = 703;
const int ID_BUTTON_TO_START = 704;
const int ID_BUTTON_STEP_DOWN = 705;
const int ID_BUTTON_STEP_UP = 706;
const int ID_BUTTON_BACK = 707;
const int ID_BUTTON_MERGE = 708;
const int ID_BUTTON_RETRANSLATION = 709;
const int ID_BUTTON_EDIT_RETRANSLATION = 710;
const int ID_REMOVE_RETRANSLATION = 711;
const int ID_BUTTON_NULL_SRC = 712;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 713;
const int ID_BUTTON_CHOOSE_TRANSLATION = 714;
const int ID_SHOWING_ALL = 715;
const int ID_BUTTON_EARLIER_TRANSLATION = 716;
const int ID_BUTTON_NO_PUNCT_COPY = 717;
...
const int ID_BITMAP_FOLDERAI = 718;
const int ID_BITMAP_FILEAI = 719;
const int ID_BITMAP_EMPTY_FOLDER = 720;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 721;
const int ID_BUTTON_HIDING_PUNCT = 722;
const int ID_SHOWING_TGT = 723;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 724;
