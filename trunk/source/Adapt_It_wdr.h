...
const int ID_FILE_MENU = 494;
const int ID_FILE_PACK_DOC = 495;
const int ID_FILE_UNPACK_DOC = 496;
const int ID_MENU = 497;
const int ID_FILE_STARTUP_WIZARD = 498;
const int ID_FILE_CLOSEKB = 499;
const int ID_FILE_CHANGEFOLDER = 500;
const int ID_FILE_SAVEKB = 501;
const int ID_FILE_BACKUP_KB = 502;
const int ID_FILE_RESTORE_KB = 503;
const int ID_EDIT_MENU = 504;
const int ID_EDIT_CUT = 505;
const int ID_EDIT_COPY = 506;
const int ID_EDIT_PASTE = 507;
const int ID_GO_TO = 508;
const int ID_EDIT_SOURCE_TEXT = 509;
const int ID_EDIT_CONSISTENCY_CHECK = 510;
const int ID_EDIT_MOVE_NOTE_FORWARD = 511;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 512;
const int ID_VIEW_MENU = 513;
const int ID_VIEW_TOOLBAR = 514;
const int ID_VIEW_STATUS_BAR = 515;
const int ID_VIEW_COMPOSE_BAR = 516;
const int ID_COPY_SOURCE = 517;
const int ID_MARKER_WRAPS_STRIP = 518;
const int ID_UNITS = 519;
const int ID_CHANGE_INTERFACE_LANGUAGE = 520;
const int ID_TOOLS_MENU = 521;
const int ID_TOOLS_DEFINE_CC = 522;
const int ID_UNLOAD_CC_TABLES = 523;
const int ID_USE_CC = 524;
const int ID_ACCEPT_CHANGES = 525;
const int ID_TOOLS_DEFINE_SILCONVERTER = 526;
const int ID_USE_SILCONVERTER = 527;
const int ID_TOOLS_KB_EDITOR = 528;
const int ID_TOOLS_AUTO_CAPITALIZATION = 529;
const int ID_RETRANS_REPORT = 530;
const int ID_TOOLS_SPLIT_DOC = 531;
const int ID_TOOLS_JOIN_DOCS = 532;
const int ID_TOOLS_MOVE_DOC = 533;
const int ID_EXPORT_IMPORT_MENU = 534;
const int ID_FILE_EXPORT_SOURCE = 535;
const int ID_FILE_EXPORT = 536;
const int ID_FILE_EXPORT_TO_RTF = 537;
const int ID_EXPORT_GLOSSES = 538;
const int ID_EXPORT_FREE_TRANS = 539;
const int ID_FILE_EXPORT_KB = 540;
const int ID_IMPORT_TO_KB = 541;
const int ID_ADVANCED_MENU = 542;
const int ID_ADVANCED_ENABLEGLOSSING = 543;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 544;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 545;
const int ID_ADVANCED_DELAY = 546;
const int ID_ADVANCED_BOOKMODE = 547;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 548;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 549;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 550;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 551;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 552;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 553;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 554;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 555;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 556;
const int ID_LAYOUT_MENU = 557;
const int ID_ALIGNMENT = 558;
const int ID_HELP_MENU = 559;
const int ID_ONLINE_HELP = 560;
const int ID_USER_FORUM = 561;
const int ID_HELP_USE_TOOLTIPS = 562;
const int ID_ADMINISTRATOR_MENU = 563;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 564;
const int ID_LOCK_CUSTOM_LOCATION = 565;
const int ID_UNLOCK_CUSTOM_LOCATION = 566;
const int ID_LOCAL_WORK_FOLDER_MENU = 567;
const int ID_SET_PASSWORD_MENU = 568;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 569;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_CREATE_NOTE = 570;
const int ID_BUTTON_PREV_NOTE = 571;
const int ID_BUTTON_NEXT_NOTE = 572;
const int ID_BUTTON_DELETE_ALL_NOTES = 573;
const int ID_BUTTON_RESPECTING_BDRY = 574;
const int ID_BUTTON_SHOWING_PUNCT = 575;
const int ID_BUTTON_TO_END = 576;
const int ID_BUTTON_TO_START = 577;
const int ID_BUTTON_STEP_DOWN = 578;
const int ID_BUTTON_STEP_UP = 579;
const int ID_BUTTON_BACK = 580;
const int ID_BUTTON_MERGE = 581;
const int ID_BUTTON_RESTORE = 582;
const int ID_BUTTON_RETRANSLATION = 583;
const int ID_BUTTON_EDIT_RETRANSLATION = 584;
const int ID_REMOVE_RETRANSLATION = 585;
const int ID_BUTTON_NULL_SRC = 586;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 587;
const int ID_BUTTON_CHOOSE_TRANSLATION = 588;
const int ID_SHOWING_ALL = 589;
const int ID_BUTTON_EARLIER_TRANSLATION = 590;
const int ID_BUTTON_NO_PUNCT_COPY = 591;
...
const int ID_BITMAP_FOLDERAI = 592;
const int ID_BITMAP_FILEAI = 593;
const int ID_BITMAP_EMPTY_FOLDER = 594;
