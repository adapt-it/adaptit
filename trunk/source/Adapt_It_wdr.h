...
const int ID_TEXTCTRL_SOURCE_PHRASE_2 = 624;
const int ID_TEXTCTRL_TARGET_PHRASE_2 = 625;
const int ID_TEXT_EXISTS_STR = 626;
const int ID_RADIO_STORE_NORMALLY = 627;
const int ID_RADIO_NOT_IN_KB_LEAVEINDOC = 628;
const int ID_CHECK_DO_SAME2 = 629;
wxSizer *ConsistencyCheck_ExistsNoTU_DlgFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

// Declare menubar functions

const int ID_FILE_MENU = 630;
const int ID_SAVE_AS = 631;
const int ID_FILE_PACK_DOC = 632;
const int ID_FILE_UNPACK_DOC = 633;
const int ID_MENU = 634;
const int ID_FILE_STARTUP_WIZARD = 635;
const int ID_FILE_CLOSEKB = 636;
const int ID_FILE_CHANGEFOLDER = 637;
const int ID_FILE_SAVEKB = 638;
const int ID_FILE_BACKUP_KB = 639;
const int ID_FILE_RESTORE_KB = 640;
const int ID_EDIT_MENU = 641;
const int ID_EDIT_CUT = 642;
const int ID_EDIT_COPY = 643;
const int ID_EDIT_PASTE = 644;
const int ID_GO_TO = 645;
const int ID_EDIT_SOURCE_TEXT = 646;
const int ID_EDIT_CONSISTENCY_CHECK = 647;
const int ID_EDIT_MOVE_NOTE_FORWARD = 648;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 649;
const int ID_VIEW_MENU = 650;
const int ID_VIEW_TOOLBAR = 651;
const int ID_VIEW_STATUS_BAR = 652;
const int ID_VIEW_COMPOSE_BAR = 653;
const int ID_COPY_SOURCE = 654;
const int ID_MARKER_WRAPS_STRIP = 655;
const int ID_UNITS = 656;
const int ID_CHANGE_INTERFACE_LANGUAGE = 657;
const int ID_VIEW_SHOW_ADMIN_MENU = 658;
const int ID_TOOLS_MENU = 659;
const int ID_TOOLS_DEFINE_CC = 660;
const int ID_UNLOAD_CC_TABLES = 661;
const int ID_USE_CC = 662;
const int ID_ACCEPT_CHANGES = 663;
const int ID_TOOLS_DEFINE_SILCONVERTER = 664;
const int ID_USE_SILCONVERTER = 665;
const int ID_TOOLS_KB_EDITOR = 666;
const int ID_TOOLS_AUTO_CAPITALIZATION = 667;
const int ID_RETRANS_REPORT = 668;
const int ID_TOOLS_SPLIT_DOC = 669;
const int ID_TOOLS_JOIN_DOCS = 670;
const int ID_TOOLS_MOVE_DOC = 671;
const int ID_EXPORT_IMPORT_MENU = 672;
const int ID_FILE_EXPORT_SOURCE = 673;
const int ID_FILE_EXPORT = 674;
const int ID_FILE_EXPORT_TO_RTF = 675;
const int ID_EXPORT_GLOSSES = 676;
const int ID_EXPORT_FREE_TRANS = 677;
const int ID_FILE_EXPORT_KB = 678;
const int ID_IMPORT_TO_KB = 679;
const int ID_MENU_IMPORT_EDITED_SOURCE_TEXT = 680;
const int ID_ADVANCED_MENU = 681;
const int ID_ADVANCED_SEE_GLOSSES = 682;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 683;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 684;
const int ID_ADVANCED_DELAY = 685;
const int ID_ADVANCED_BOOKMODE = 686;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 687;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 688;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 689;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 690;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 691;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 692;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 693;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 694;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 695;
const int ID_LAYOUT_MENU = 696;
const int ID_ALIGNMENT = 697;
const int ID_HELP_MENU = 698;
const int ID_ONLINE_HELP = 699;
const int ID_REPORT_A_PROBLEM = 700;
const int ID_GIVE_FEEDBACK = 701;
const int ID_HELP_USE_TOOLTIPS = 702;
const int ID_ADMINISTRATOR_MENU = 703;
const int ID_SETUP_EDITOR_COLLABORATION = 704;
const int ID_EDIT_USER_MENU_SETTINGS_PROFILE = 705;
const int ID_ASSIGN_LOCATIONS_FOR_INPUTS_OUTPUTS = 706;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 707;
const int ID_SET_PASSWORD_MENU = 708;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 709;
const int ID_LOCK_CUSTOM_LOCATION = 710;
const int ID_UNLOCK_CUSTOM_LOCATION = 711;
const int ID_LOCAL_WORK_FOLDER_MENU = 712;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_GUESSER = 713;
const int ID_BUTTON_CREATE_NOTE = 714;
const int ID_BUTTON_PREV_NOTE = 715;
const int ID_BUTTON_NEXT_NOTE = 716;
const int ID_BUTTON_DELETE_ALL_NOTES = 717;
const int ID_BUTTON_RESPECTING_BDRY = 718;
const int ID_BUTTON_SHOWING_PUNCT = 719;
const int ID_BUTTON_TO_END = 720;
const int ID_BUTTON_TO_START = 721;
const int ID_BUTTON_STEP_DOWN = 722;
const int ID_BUTTON_STEP_UP = 723;
const int ID_BUTTON_BACK = 724;
const int ID_BUTTON_MERGE = 725;
const int ID_BUTTON_RETRANSLATION = 726;
const int ID_BUTTON_EDIT_RETRANSLATION = 727;
const int ID_REMOVE_RETRANSLATION = 728;
const int ID_BUTTON_NULL_SRC = 729;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 730;
const int ID_BUTTON_CHOOSE_TRANSLATION = 731;
const int ID_SHOWING_ALL = 732;
const int ID_BUTTON_EARLIER_TRANSLATION = 733;
const int ID_BUTTON_NO_PUNCT_COPY = 734;
...
const int ID_BITMAP_FOLDERAI = 735;
const int ID_BITMAP_FILEAI = 736;
const int ID_BITMAP_EMPTY_FOLDER = 737;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 738;
const int ID_BUTTON_HIDING_PUNCT = 739;
const int ID_SHOWING_TGT = 740;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 741;
