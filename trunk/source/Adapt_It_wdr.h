...
const int ID_LINE_2 = 589;
const int ID_TEXT_STATIC_SELECT_SUITABLE_AI_PROJECT = 590;
const int ID_COMBO_AI_PROJECTS = 591;
const int ID_RADIOBOX_COLLABORATION_ON_OFF = 592;
extern wxSizer *pNewNamesSizer2;
const int ID_TEXT_ENTER_LANG_NAME = 593;
const int ID_TEXT_AS_STATIC_NEW_AI_PROJ_NAME = 594;
const int ID_TEXT_SRC_NAME_LABEL = 595;
const int ID_TEXTCTRL_SRC_LANG_NAME = 596;
const int ID_TEXT_TGT_NAME_LABEL = 597;
const int ID_TEXTCTRL_TGT_LANG_NAME = 598;
const int ID_TEXTCTRL_NEW_AI_PROJ_NAME = 599;
wxSizer *SetupEditorCollaborationFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_RADIOBOX_WHOLE_BOOK_OR_CHAPTER = 600;
const int ID_LISTBOX_BOOK_NAMES = 601;
const int ID_TEXT_SELECT_A_CHAPTER = 602;
const int ID_LISTCTRL_CHAPTER_NUMBER_AND_STATUS = 603;
const int ID_TEXTCTRL_AS_STATIC_NOTE = 604;
const int ID_BUTTON_CHANGE_PROJECTS = 605;
extern wxSizer *pProjectSelectionControlsSizer;
const int ID_TEXT_DO_NOT_CHANGE_NOTE = 606;
const int ID_COMBO_SOURCE_PROJECT_NAME = 607;
const int ID_COMBO_DESTINATION_PROJECT_NAME = 608;
const int ID_COMBO_FREE_TRANS_PROJECT_NAME = 609;
const int ID_BUTTON_NO_FREE_TRANS = 610;
...
const int ID_TEXTCTRL_SOURCE_TEXT_VERSE = 613;
const int ID_TEXTCTRL_AS_STATIC_INSTRUCTIONS = 614;
const int ID_TEXTCTRL_AS_STATIC_EARLIER_FROM = 615;
const int ID_TEXTCTRL_AS_STATIC_RECENT_FROM = 616;
const int ID_TEXTCTRL_EARLIER_VERSION = 617;
const int ID_TEXTCTRL_RECENT_VERSION = 618;
const int ID_BUTTON_USE_EARLIER = 619;
const int ID_BUTTON_USE_RECENT = 620;
...
const int ID_SETUP_EDITOR_COLLABORATION = 725;
const int ID_EDIT_USER_MENU_SETTINGS_PROFILE = 726;
const int ID_ASSIGN_LOCATIONS_FOR_INPUTS_OUTPUTS = 727;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 728;
const int ID_SET_PASSWORD_MENU = 729;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 730;
const int ID_LOCK_CUSTOM_LOCATION = 731;
const int ID_UNLOCK_CUSTOM_LOCATION = 732;
const int ID_LOCAL_WORK_FOLDER_MENU = 733;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_GUESSER = 734;
const int ID_BUTTON_CREATE_NOTE = 735;
const int ID_BUTTON_PREV_NOTE = 736;
const int ID_BUTTON_NEXT_NOTE = 737;
const int ID_BUTTON_DELETE_ALL_NOTES = 738;
const int ID_BUTTON_RESPECTING_BDRY = 739;
const int ID_BUTTON_SHOWING_PUNCT = 740;
const int ID_BUTTON_TO_END = 741;
const int ID_BUTTON_TO_START = 742;
const int ID_BUTTON_STEP_DOWN = 743;
const int ID_BUTTON_STEP_UP = 744;
const int ID_BUTTON_BACK = 745;
const int ID_BUTTON_MERGE = 746;
const int ID_BUTTON_RETRANSLATION = 747;
const int ID_BUTTON_EDIT_RETRANSLATION = 748;
const int ID_REMOVE_RETRANSLATION = 749;
const int ID_BUTTON_NULL_SRC = 750;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 751;
const int ID_BUTTON_CHOOSE_TRANSLATION = 752;
const int ID_SHOWING_ALL = 753;
const int ID_BUTTON_EARLIER_TRANSLATION = 754;
const int ID_BUTTON_NO_PUNCT_COPY = 755;
...
const int ID_BITMAP_FOLDERAI = 756;
const int ID_BITMAP_FILEAI = 757;
const int ID_BITMAP_EMPTY_FOLDER = 758;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 759;
const int ID_BUTTON_HIDING_PUNCT = 760;
const int ID_SHOWING_TGT = 761;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 762;
