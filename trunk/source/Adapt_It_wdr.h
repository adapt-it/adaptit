...
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 691;
const int ID_LOCK_CUSTOM_LOCATION = 692;
const int ID_UNLOCK_CUSTOM_LOCATION = 693;
const int ID_LOCAL_WORK_FOLDER_MENU = 694;
const int ID_SET_PASSWORD_MENU = 695;
const int ID_SETUP_EDITOR_COLLABORATION = 696;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 697;
const int ID_ASSIGN_LOCATIONS_FOR_INPUTS_OUTPUTS = 698;
