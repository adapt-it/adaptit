...
const int ID_BUTTON_RENAME = 488;
const int ID_BUTTON_DELETE = 489;
wxSizer *MoveOrCopyFilesOrFoldersFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXT_MSG1 = 490;
const int ID_TEXTCTRL_SOURCE_FILE_DETAILS = 491;
const int ID_TEXTCTRL_DESTINATION_FILE_DETAILS = 492;
const int ID_RADIOBUTTON_REPLACE = 493;
const int ID_RADIOBUTTON_NO_COPY = 494;
const int ID_RADIOBUTTON_COPY_AND_RENAME = 495;
const int ID_TEXT_MODIFY_NAME = 496;
const int ID_CHECKBOX_HANDLE_SAME = 497;
wxSizer *FilenameConflictFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

// Declare menubar functions

const int ID_FILE_MENU = 498;
const int ID_FILE_PACK_DOC = 499;
const int ID_FILE_UNPACK_DOC = 500;
const int ID_MENU = 501;
const int ID_FILE_STARTUP_WIZARD = 502;
const int ID_FILE_CLOSEKB = 503;
const int ID_FILE_CHANGEFOLDER = 504;
const int ID_FILE_SAVEKB = 505;
const int ID_FILE_BACKUP_KB = 506;
const int ID_FILE_RESTORE_KB = 507;
...
const int ID_EXPORT_IMPORT_MENU = 538;
const int ID_FILE_EXPORT_SOURCE = 539;
const int ID_FILE_EXPORT = 540;
const int ID_FILE_EXPORT_TO_RTF = 541;
const int ID_EXPORT_GLOSSES = 542;
const int ID_EXPORT_FREE_TRANS = 543;
const int ID_FILE_EXPORT_KB = 544;
const int ID_IMPORT_TO_KB = 545;
const int ID_ADVANCED_MENU = 546;
const int ID_ADVANCED_ENABLEGLOSSING = 547;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 548;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 549;
const int ID_ADVANCED_DELAY = 550;
const int ID_ADVANCED_BOOKMODE = 551;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 552;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 553;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 554;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 555;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 556;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 557;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 558;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 559;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 560;
const int ID_LAYOUT_MENU = 561;
const int ID_ALIGNMENT = 562;
const int ID_HELP_MENU = 563;
const int ID_ONLINE_HELP = 564;
const int ID_USER_FORUM = 565;
const int ID_HELP_USE_TOOLTIPS = 566;
const int ID_ADMINISTRATOR_MENU = 567;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 568;
const int ID_LOCK_CUSTOM_LOCATION = 569;
const int ID_UNLOCK_CUSTOM_LOCATION = 570;
const int ID_LOCAL_WORK_FOLDER_MENU = 571;
const int ID_SET_PASSWORD_MENU = 572;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 573;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_CREATE_NOTE = 574;
const int ID_BUTTON_PREV_NOTE = 575;
const int ID_BUTTON_NEXT_NOTE = 576;
const int ID_BUTTON_DELETE_ALL_NOTES = 577;
const int ID_BUTTON_RESPECTING_BDRY = 578;
const int ID_BUTTON_SHOWING_PUNCT = 579;
const int ID_BUTTON_TO_END = 580;
const int ID_BUTTON_TO_START = 581;
const int ID_BUTTON_STEP_DOWN = 582;
const int ID_BUTTON_STEP_UP = 583;
const int ID_BUTTON_BACK = 584;
const int ID_BUTTON_MERGE = 585;
const int ID_BUTTON_RESTORE = 586;
const int ID_BUTTON_RETRANSLATION = 587;
const int ID_BUTTON_EDIT_RETRANSLATION = 588;
const int ID_REMOVE_RETRANSLATION = 589;
const int ID_BUTTON_NULL_SRC = 590;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 591;
const int ID_BUTTON_CHOOSE_TRANSLATION = 592;
const int ID_SHOWING_ALL = 593;
const int ID_BUTTON_EARLIER_TRANSLATION = 594;
const int ID_BUTTON_NO_PUNCT_COPY = 595;
...
const int ID_BITMAP_FOLDERAI = 596;
const int ID_BITMAP_FILEAI = 597;
const int ID_BITMAP_EMPTY_FOLDER = 598;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 599;
const int ID_BUTTON_HIDING_PUNCT = 600;
const int ID_SHOWING_TGT = 601;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 602;
