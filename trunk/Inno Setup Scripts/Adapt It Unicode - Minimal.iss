...
OutputBaseFilename=Adapt_It_WX_6_0_0_Unicode_Mimimal
...
Source: "C:\C++ Programming\Adapt It\adaptit\setup Unicode - Minimal\rdwrtp7.exe"; DestDir: "{code:PTInstallDir}"; Flags: ignoreversion uninsneveruninstall onlyifdoesntexist; 
