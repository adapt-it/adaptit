...
cp "$imagesQSDirSrc/back_button.gif" "$imagesQSDir"
cp "$imagesQSDirSrc/Image2.gif" "$imagesQSDir"
cp "$imagesQSDirSrc/Image3.gif" "$imagesQSDir"
cp "$imagesQSDirSrc/Image4.gif" "$imagesQSDir"
cp "$imagesQSDirSrc/Image5.gif" "$imagesQSDir"
cp "$imagesQSDirSrc/Image6.gif" "$imagesQSDir"
cp "$imagesQSDirSrc/Image7.gif" "$imagesQSDir"
cp "$imagesQSDirSrc/Image8.gif" "$imagesQSDir"
cp "$imagesQSDirSrc/Image9.gif" "$imagesQSDir"
cp "$imagesQSDirSrc/Image10.gif" "$imagesQSDir"
cp "$imagesQSDirSrc/Image11.gif" "$imagesQSDir"
cp "$imagesQSDirSrc/Image12.gif" "$imagesQSDir"
cp "$imagesQSDirSrc/Image13.gif" "$imagesQSDir"
cp "$imagesQSDirSrc/Image14.gif" "$imagesQSDir"
cp "$imagesQSDirSrc/Image15.gif" "$imagesQSDir"
cp "$imagesQSDirSrc/Image16.gif" "$imagesQSDir"
cp "$imagesQSDirSrc/Image17.gif" "$imagesQSDir"
cp "$imagesQSDirSrc/Image19.gif" "$imagesQSDir"
cp "$imagesQSDirSrc/Image20.gif" "$imagesQSDir"
...
cp "$imagesHADirSrc/AdminMenuSetupBECollab.gif" "$imagesHADir"
cp "$imagesHADirSrc/AdminMenuSetupPTCollab.gif" "$imagesHADir"
cp "$imagesHADirSrc/ai_new_icon.gif" "$imagesHADir"
cp "$imagesHADirSrc/Assign_locations_dlg_nothing_ticked.gif" "$imagesHADir"
cp "$imagesHADirSrc/Assign_locations_for_inputs_outputs_all_checked.gif" "$imagesHADir"
cp "$imagesHADirSrc/BalsaOpeningScreen.gif" "$imagesHADir"
cp "$imagesHADirSrc/BENewProject.gif" "$imagesHADir"
cp "$imagesHADirSrc/CollabErrorLinux1.gif" "$imagesHADir"
cp "$imagesHADirSrc/CollabErrorLinux2.gif" "$imagesHADir"
cp "$imagesHADirSrc/ChangeParatextProjects.gif" "$imagesHADir"
cp "$imagesHADirSrc/Enter_src_lang_name_dlgBE.gif" "$imagesHADir"
cp "$imagesHADirSrc/Enter_tgt_lang_name_dlgBE.gif" "$imagesHADir"
cp "$imagesHADirSrc/Get_src_text_from_BE_proj_no_options_showing.gif" "$imagesHADir"
cp "$imagesHADirSrc/GetSourceTextFromEditorNoOptions.gif" "$imagesHADir"
cp "$imagesHADirSrc/GetSourceTextFromEditorOptionsNoLangNameCtrls.gif" "$imagesHADir"
cp "$imagesHADirSrc/GetSourceTextFromEditorOptionsWithLangNameCtrls.gif" "$imagesHADir"
cp "$imagesHADirSrc/Give_Feedback.gif" "$imagesHADir"
cp "$imagesHADirSrc/GuesserSettingsTBtn.gif" "$imagesHADir"
cp "$imagesHADirSrc/Move_or_Copy_Folders_or_Files.gif" "$imagesHADir"
cp "$imagesHADirSrc/PT-BE_no_books_found_msg.gif" "$imagesHADir"
cp "$imagesHADirSrc/PT-BE_no_chapters_and_verses_found_msg.gif" "$imagesHADir"
cp "$imagesHADirSrc/PTNewProject.gif" "$imagesHADir"
cp "$imagesHADirSrc/Reminder_to_setup_PT_first_before_assigning_locations.gif" "$imagesHADir"
cp "$imagesHADirSrc/Report_a_problemDlg.gif" "$imagesHADir"
cp "$imagesHADirSrc/SetUpBibleditCollaboration.gif" "$imagesHADir"
cp "$imagesHADirSrc/SetUpBibleditCollaborationWithLangNamesCtrls.gif" "$imagesHADir"
cp "$imagesHADirSrc/SetupPTCollabNoLangNamesCtrls.gif" "$imagesHADir"
cp "$imagesHADirSrc/SetupPTCollabWithLangNamesCtrls.gif" "$imagesHADir"
cp "$imagesHADirSrc/SetupPTCollabWithoutLangNamesCtrls.gif" "$imagesHADir"
cp "$imagesHADirSrc/User_workflow_profiles.gif" "$imagesHADir"
