...
const int ID_FILE_MENU = 595;
const int ID_MENU_GET_SOURCE_FROM_PT = 596;
const int ID_MENU_TRANSFER_TRANS_TO_PT = 597;
const int ID_SAVE_AS = 598;
const int ID_FILE_PACK_DOC = 599;
const int ID_FILE_UNPACK_DOC = 600;
const int ID_MENU = 601;
const int ID_FILE_STARTUP_WIZARD = 602;
const int ID_FILE_CLOSEKB = 603;
const int ID_FILE_CHANGEFOLDER = 604;
const int ID_FILE_SAVEKB = 605;
const int ID_FILE_BACKUP_KB = 606;
const int ID_FILE_RESTORE_KB = 607;
const int ID_EDIT_MENU = 608;
const int ID_EDIT_CUT = 609;
const int ID_EDIT_COPY = 610;
const int ID_EDIT_PASTE = 611;
const int ID_GO_TO = 612;
const int ID_EDIT_SOURCE_TEXT = 613;
const int ID_EDIT_CONSISTENCY_CHECK = 614;
const int ID_EDIT_MOVE_NOTE_FORWARD = 615;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 616;
const int ID_VIEW_MENU = 617;
const int ID_VIEW_TOOLBAR = 618;
const int ID_VIEW_STATUS_BAR = 619;
const int ID_VIEW_COMPOSE_BAR = 620;
const int ID_COPY_SOURCE = 621;
const int ID_MARKER_WRAPS_STRIP = 622;
const int ID_UNITS = 623;
const int ID_CHANGE_INTERFACE_LANGUAGE = 624;
const int ID_TOOLS_MENU = 625;
const int ID_TOOLS_DEFINE_CC = 626;
const int ID_UNLOAD_CC_TABLES = 627;
const int ID_USE_CC = 628;
const int ID_ACCEPT_CHANGES = 629;
const int ID_TOOLS_DEFINE_SILCONVERTER = 630;
const int ID_USE_SILCONVERTER = 631;
const int ID_TOOLS_KB_EDITOR = 632;
const int ID_TOOLS_AUTO_CAPITALIZATION = 633;
const int ID_RETRANS_REPORT = 634;
const int ID_TOOLS_SPLIT_DOC = 635;
const int ID_TOOLS_JOIN_DOCS = 636;
const int ID_TOOLS_MOVE_DOC = 637;
const int ID_EXPORT_IMPORT_MENU = 638;
const int ID_FILE_EXPORT_SOURCE = 639;
const int ID_FILE_EXPORT = 640;
const int ID_FILE_EXPORT_TO_RTF = 641;
const int ID_EXPORT_GLOSSES = 642;
const int ID_EXPORT_FREE_TRANS = 643;
const int ID_EXPORT_OXES = 644;
const int ID_FILE_EXPORT_KB = 645;
const int ID_IMPORT_TO_KB = 646;
const int ID_MENU_IMPORT_EDITED_SOURCE_TEXT = 647;
const int ID_ADVANCED_MENU = 648;
const int ID_ADVANCED_ENABLEGLOSSING = 649;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 650;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 651;
const int ID_ADVANCED_DELAY = 652;
const int ID_ADVANCED_BOOKMODE = 653;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 654;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 655;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 656;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 657;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 658;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 659;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 660;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 661;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 662;
const int ID_LAYOUT_MENU = 663;
const int ID_ALIGNMENT = 664;
const int ID_HELP_MENU = 665;
const int ID_ONLINE_HELP = 666;
const int ID_REPORT_A_PROBLEM = 667;
const int ID_GIVE_FEEDBACK = 668;
const int ID_HELP_USE_TOOLTIPS = 669;
const int ID_ADMINISTRATOR_MENU = 670;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 671;
const int ID_LOCK_CUSTOM_LOCATION = 672;
const int ID_UNLOCK_CUSTOM_LOCATION = 673;
const int ID_LOCAL_WORK_FOLDER_MENU = 674;
const int ID_SET_PASSWORD_MENU = 675;
const int ID_SETUP_PARATEXT_COLLABORATION = 676;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 677;
const int ID_SOURCE_DATA_FOLDER = 678;
const int ID_EXPORT_DATA_FOLDER = 679;
const int ID_EDIT_USER_MENU_SETTINGS_PROFILE = 680;
...
const int ID_BUTTON_GUESSER = 681;
const int ID_BUTTON_CREATE_NOTE = 682;
const int ID_BUTTON_PREV_NOTE = 683;
const int ID_BUTTON_NEXT_NOTE = 684;
const int ID_BUTTON_DELETE_ALL_NOTES = 685;
const int ID_BUTTON_RESPECTING_BDRY = 686;
const int ID_BUTTON_SHOWING_PUNCT = 687;
const int ID_BUTTON_TO_END = 688;
const int ID_BUTTON_TO_START = 689;
const int ID_BUTTON_STEP_DOWN = 690;
const int ID_BUTTON_STEP_UP = 691;
const int ID_BUTTON_BACK = 692;
const int ID_BUTTON_MERGE = 693;
const int ID_BUTTON_RETRANSLATION = 694;
const int ID_BUTTON_EDIT_RETRANSLATION = 695;
const int ID_REMOVE_RETRANSLATION = 696;
const int ID_BUTTON_NULL_SRC = 697;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 698;
const int ID_BUTTON_CHOOSE_TRANSLATION = 699;
const int ID_SHOWING_ALL = 700;
const int ID_BUTTON_EARLIER_TRANSLATION = 701;
const int ID_BUTTON_NO_PUNCT_COPY = 702;
...
const int ID_BITMAP_FOLDERAI = 703;
const int ID_BITMAP_FILEAI = 704;
const int ID_BITMAP_EMPTY_FOLDER = 705;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 706;
const int ID_BUTTON_HIDING_PUNCT = 707;
const int ID_SHOWING_TGT = 708;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 709;
