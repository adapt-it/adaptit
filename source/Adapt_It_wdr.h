...
const int ID_TEXT_TOP_TITLE = 570;
const int ID_TEXTCTRL_AS_STATIC_TOP_NOTE = 571;
const int ID_TEXT_STATIC_LIST_OF_PROJECTS = 572;
const int IDC_LIST_OF_PT_PROJECTS = 573;
const int ID_TEXTCTRL_AS_STATIC_IMPORTANT_BOTTOM_NOTE = 574;
const int ID_CHECKBOX_COLLABORATE_TOGETHER = 575;
const int ID_BUTTON = 576;
wxSizer *SetupEditorCollaborationFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_COMBO_SOURCE_PT_PROJECT_NAME = 577;
const int ID_COMBO_DESTINATION_PT_PROJECT_NAME = 578;
const int ID_RADIOBOX_WHOLE_BOOK_OR_CHAPTER = 579;
const int ID_LISTBOX_BOOK_NAMES = 580;
const int ID_LISTBOX_CHAPTER_NUMBER_AND_STATUS = 581;
const int ID_TEXTCTRL_AS_STATIC_NOTE = 582;
wxSizer *GetSourceTextFromEditorDlgFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXTCTRL_SOURCE_TEXT_VERSE = 583;
const int ID_TEXTCTRL_AS_STATIC_EARLIER_FROM = 584;
const int ID_TEXTCTRL_AS_STATIC_RECENT_FROM = 585;
const int ID_TEXTCTRL_EARLIER_VERSION = 586;
const int ID_TEXTCTRL_RECENT_VERSION = 587;
const int ID_BUTTON_USE_EARLIER = 588;
const int ID_BUTTON_USE_RECENT = 589;
wxSizer *ConflictResolutionDlgFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

// Declare menubar functions

const int ID_FILE_MENU = 590;
const int ID_MENU_GET_SOURCE_FROM_PT = 591;
const int ID_MENU_TRANSFER_TRANS_TO_PT = 592;
const int ID_SAVE_AS = 593;
const int ID_FILE_PACK_DOC = 594;
const int ID_FILE_UNPACK_DOC = 595;
const int ID_MENU = 596;
const int ID_FILE_STARTUP_WIZARD = 597;
const int ID_FILE_CLOSEKB = 598;
const int ID_FILE_CHANGEFOLDER = 599;
const int ID_FILE_SAVEKB = 600;
const int ID_FILE_BACKUP_KB = 601;
const int ID_FILE_RESTORE_KB = 602;
const int ID_EDIT_MENU = 603;
const int ID_EDIT_CUT = 604;
const int ID_EDIT_COPY = 605;
const int ID_EDIT_PASTE = 606;
const int ID_GO_TO = 607;
const int ID_EDIT_SOURCE_TEXT = 608;
const int ID_EDIT_CONSISTENCY_CHECK = 609;
const int ID_EDIT_MOVE_NOTE_FORWARD = 610;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 611;
const int ID_VIEW_MENU = 612;
const int ID_VIEW_TOOLBAR = 613;
const int ID_VIEW_STATUS_BAR = 614;
const int ID_VIEW_COMPOSE_BAR = 615;
const int ID_COPY_SOURCE = 616;
const int ID_MARKER_WRAPS_STRIP = 617;
const int ID_UNITS = 618;
const int ID_CHANGE_INTERFACE_LANGUAGE = 619;
const int ID_TOOLS_MENU = 620;
const int ID_TOOLS_DEFINE_CC = 621;
const int ID_UNLOAD_CC_TABLES = 622;
const int ID_USE_CC = 623;
const int ID_ACCEPT_CHANGES = 624;
const int ID_TOOLS_DEFINE_SILCONVERTER = 625;
const int ID_USE_SILCONVERTER = 626;
const int ID_TOOLS_KB_EDITOR = 627;
const int ID_TOOLS_AUTO_CAPITALIZATION = 628;
const int ID_RETRANS_REPORT = 629;
const int ID_TOOLS_SPLIT_DOC = 630;
const int ID_TOOLS_JOIN_DOCS = 631;
const int ID_TOOLS_MOVE_DOC = 632;
const int ID_EXPORT_IMPORT_MENU = 633;
const int ID_FILE_EXPORT_SOURCE = 634;
const int ID_FILE_EXPORT = 635;
const int ID_FILE_EXPORT_TO_RTF = 636;
const int ID_EXPORT_GLOSSES = 637;
const int ID_EXPORT_FREE_TRANS = 638;
const int ID_EXPORT_OXES = 639;
const int ID_FILE_EXPORT_KB = 640;
const int ID_IMPORT_TO_KB = 641;
