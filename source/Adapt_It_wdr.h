...
const int ID_TEXT_DO_NOT_CHANGE_NOTE = 610;
const int ID_COMBO_SOURCE_PROJECT_NAME = 611;
const int ID_COMBO_DESTINATION_PROJECT_NAME = 612;
const int ID_COMBO_FREE_TRANS_PROJECT_NAME = 613;
const int ID_TEXT_USE_DROP_DOWN = 614;
extern wxSizer *pNewNamesSizer;
const int ID_LINE_3 = 615;
wxSizer *GetSourceTextFromEditorDlgFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXTCTRL_AS_STATIC_TOP_INFO = 616;
const int ID_CHECKBOX_PROTECT_SOURCE_INPUTS = 617;
const int ID_BUTTON_PRE_LOAD_SOURCE_TEXTS = 618;
const int ID_CHECKBOX_PROTECT_FREETRANS_OUTPUTS = 619;
const int ID_CHECKBOX_PROTECT_FREETRANS_RTF_OUTPUTS = 620;
const int ID_CHECKBOX_PROTECT_GLOSS_OUTPUTS = 621;
const int ID_CHECKBOX_PROTECT_GLOSS_RTF_OUTPUTS = 622;
const int ID_CHECKBOX_PROTECT_SOURCE_OUTPUTS = 623;
const int ID_CHECKBOX_PROTECT_SOURCE_RTF_OUTPUTS = 624;
const int ID_CHECKBOX_PROTECT_TARGET_OUTPUTS = 625;
const int ID_CHECKBOX_PROTECT_TARGET_RTF_OUTPUTS = 626;
const int ID_CHECKBOX_PROTECT_REPORTS_OUTPUTS = 627;
const int ID_CHECKBOX_PROTECT_INTERLINEAR_RTF_OUTPUTS = 628;
const int ID_CHECKBOX_PROTECT_KB_INPUTS_AND_OUTPUTS = 629;
const int ID_CHECKBOX_PROTECT_LIFT_INPUTS_AND_OUTPUTS = 630;
const int ID_CHECKBOX_PROTECT_PACKED_INPUTS_AND_OUTPUTS = 631;
const int ID_CHECKBOX_PROTECT_CCTABLE_INPUTS_AND_OUTPUTS = 632;
const int ID_BUTTON_UNSELECT_ALL_CHECKBOXES = 633;
const int ID_BUTTON_SELECT_ALL_CHECKBOXES = 634;
wxSizer *AssignLocationsForInputsOutputsFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXTCTRL_SOURCE_PHRASE_1 = 635;
const int ID_TEXT_EMPTY_STR = 636;
const int ID_RADIO_NO_ADAPTATION = 637;
const int ID_RADIO_LEAVE_HOLE = 638;
const int ID_RADIO_NOT_IN_KB = 639;
const int ID_RADIOBUTTON_TYPE_AORG = 640;
const int ID_TEXTCTRL_TYPED_AORG = 641;
const int ID_CHECK_DO_SAME = 642;
wxSizer *ConsistencyCheck_EmptyNoTU_DlgFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXTCTRL_SOURCE_PHRASE_2 = 643;
const int ID_TEXTCTRL_TARGET_PHRASE_2 = 644;
const int ID_TEXT_EXISTS_STR = 645;
const int ID_RADIO_STORE_NORMALLY = 646;
const int ID_RADIO_NOT_IN_KB_LEAVEINDOC = 647;
const int ID_CHECK_DO_SAME2 = 648;
wxSizer *ConsistencyCheck_ExistsNoTU_DlgFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_BITMAPBUTTON_MOVE_BACK = 649;
const int ID_BITMAPBUTTON_MOVE_FORWARD = 650;
const int ID_BUTTON_OPEN_HTML_FILE = 651;
const int ID_TEXTCTRL_HTML_FILE_PATH = 652;
const int ID_HTML_WINDOW = 653;
