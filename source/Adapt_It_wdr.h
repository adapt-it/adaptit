...
const int ID_FILE_MENU = 652;
const int ID_SAVE_AS = 653;
const int ID_FILE_PACK_DOC = 654;
const int ID_FILE_UNPACK_DOC = 655;
const int ID_MENU = 656;
const int ID_FILE_STARTUP_WIZARD = 657;
const int ID_FILE_CLOSEKB = 658;
const int ID_FILE_CHANGEFOLDER = 659;
const int ID_FILE_SAVEKB = 660;
const int ID_FILE_BACKUP_KB = 661;
const int ID_FILE_RESTORE_KB = 662;
const int ID_EDIT_MENU = 663;
const int ID_EDIT_CUT = 664;
const int ID_EDIT_COPY = 665;
const int ID_EDIT_PASTE = 666;
const int ID_GO_TO = 667;
const int ID_EDIT_SOURCE_TEXT = 668;
const int ID_EDIT_CONSISTENCY_CHECK = 669;
const int ID_EDIT_MOVE_NOTE_FORWARD = 670;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 671;
const int ID_VIEW_MENU = 672;
const int ID_VIEW_TOOLBAR = 673;
const int ID_VIEW_STATUS_BAR = 674;
const int ID_VIEW_COMPOSE_BAR = 675;
const int ID_COPY_SOURCE = 676;
const int ID_MARKER_WRAPS_STRIP = 677;
const int ID_UNITS = 678;
const int ID_CHANGE_INTERFACE_LANGUAGE = 679;
const int ID_VIEW_SHOW_ADMIN_MENU = 680;
const int ID_TOOLS_MENU = 681;
const int ID_TOOLS_DEFINE_CC = 682;
const int ID_UNLOAD_CC_TABLES = 683;
const int ID_USE_CC = 684;
const int ID_ACCEPT_CHANGES = 685;
const int ID_TOOLS_DEFINE_SILCONVERTER = 686;
const int ID_USE_SILCONVERTER = 687;
const int ID_TOOLS_KB_EDITOR = 688;
const int ID_TOOLS_AUTO_CAPITALIZATION = 689;
const int ID_RETRANS_REPORT = 690;
const int ID_TOOLS_SPLIT_DOC = 691;
const int ID_TOOLS_JOIN_DOCS = 692;
const int ID_TOOLS_MOVE_DOC = 693;
const int ID_EXPORT_IMPORT_MENU = 694;
const int ID_FILE_EXPORT_SOURCE = 695;
const int ID_FILE_EXPORT = 696;
const int ID_FILE_EXPORT_TO_RTF = 697;
const int ID_EXPORT_GLOSSES = 698;
const int ID_EXPORT_FREE_TRANS = 699;
const int ID_FILE_EXPORT_KB = 700;
const int ID_IMPORT_TO_KB = 701;
const int ID_MENU_IMPORT_EDITED_SOURCE_TEXT = 702;
const int ID_ADVANCED_MENU = 703;
const int ID_ADVANCED_SEE_GLOSSES = 704;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 705;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 706;
const int ID_ADVANCED_DELAY = 707;
const int ID_ADVANCED_BOOKMODE = 708;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 709;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 710;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 711;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 712;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 713;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 714;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 715;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 716;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 717;
const int ID_LAYOUT_MENU = 718;
const int ID_ALIGNMENT = 719;
const int ID_HELP_MENU = 720;
const int ID_MENU_AI_QUICK_START = 721;
const int ID_REPORT_A_PROBLEM = 722;
const int ID_GIVE_FEEDBACK = 723;
const int ID_HELP_USE_TOOLTIPS = 724;
const int ID_ADMINISTRATOR_MENU = 725;
const int ID_MENU_HELP_FOR_ADMINISTRATORS = 726;
const int ID_SETUP_EDITOR_COLLABORATION = 727;
const int ID_EDIT_USER_MENU_SETTINGS_PROFILE = 728;
const int ID_ASSIGN_LOCATIONS_FOR_INPUTS_OUTPUTS = 729;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 730;
const int ID_SET_PASSWORD_MENU = 731;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 732;
const int ID_LOCK_CUSTOM_LOCATION = 733;
const int ID_UNLOCK_CUSTOM_LOCATION = 734;
const int ID_LOCAL_WORK_FOLDER_MENU = 735;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_GUESSER = 736;
const int ID_BUTTON_CREATE_NOTE = 737;
const int ID_BUTTON_PREV_NOTE = 738;
const int ID_BUTTON_NEXT_NOTE = 739;
const int ID_BUTTON_DELETE_ALL_NOTES = 740;
const int ID_BUTTON_RESPECTING_BDRY = 741;
const int ID_BUTTON_SHOWING_PUNCT = 742;
const int ID_BUTTON_TO_END = 743;
const int ID_BUTTON_TO_START = 744;
const int ID_BUTTON_STEP_DOWN = 745;
const int ID_BUTTON_STEP_UP = 746;
const int ID_BUTTON_BACK = 747;
const int ID_BUTTON_MERGE = 748;
const int ID_BUTTON_RETRANSLATION = 749;
const int ID_BUTTON_EDIT_RETRANSLATION = 750;
const int ID_REMOVE_RETRANSLATION = 751;
const int ID_BUTTON_NULL_SRC = 752;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 753;
const int ID_BUTTON_CHOOSE_TRANSLATION = 754;
const int ID_SHOWING_ALL = 755;
const int ID_BUTTON_EARLIER_TRANSLATION = 756;
const int ID_BUTTON_NO_PUNCT_COPY = 757;
...
const int ID_BITMAP_FOLDERAI = 758;
const int ID_BITMAP_FILEAI = 759;
const int ID_BITMAP_EMPTY_FOLDER = 760;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 761;
const int ID_BUTTON_HIDING_PUNCT = 762;
const int ID_SHOWING_TGT = 763;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 764;
