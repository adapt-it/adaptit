...
const int ID_CHECKBOX_PROTECT_KB_INPUTS_AND_OUTPUTS = 610;
const int ID_CHECKBOX_PROTECT_LIFT_INPUTS_AND_OUTPUTS = 611;
const int ID_BUTTON_SELECT_ALL_CHECKBOXES = 612;
wxSizer *AssignLocationsForInputsOutputsFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

// Declare menubar functions

const int ID_FILE_MENU = 613;
const int ID_SAVE_AS = 614;
const int ID_FILE_PACK_DOC = 615;
const int ID_FILE_UNPACK_DOC = 616;
const int ID_MENU = 617;
const int ID_FILE_STARTUP_WIZARD = 618;
const int ID_FILE_CLOSEKB = 619;
const int ID_FILE_CHANGEFOLDER = 620;
const int ID_FILE_SAVEKB = 621;
const int ID_FILE_BACKUP_KB = 622;
const int ID_FILE_RESTORE_KB = 623;
const int ID_EDIT_MENU = 624;
const int ID_EDIT_CUT = 625;
const int ID_EDIT_COPY = 626;
const int ID_EDIT_PASTE = 627;
const int ID_GO_TO = 628;
const int ID_EDIT_SOURCE_TEXT = 629;
const int ID_EDIT_CONSISTENCY_CHECK = 630;
const int ID_EDIT_MOVE_NOTE_FORWARD = 631;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 632;
const int ID_VIEW_MENU = 633;
const int ID_VIEW_TOOLBAR = 634;
const int ID_VIEW_STATUS_BAR = 635;
const int ID_VIEW_COMPOSE_BAR = 636;
const int ID_COPY_SOURCE = 637;
const int ID_MARKER_WRAPS_STRIP = 638;
const int ID_UNITS = 639;
const int ID_CHANGE_INTERFACE_LANGUAGE = 640;
const int ID_TOOLS_MENU = 641;
const int ID_TOOLS_DEFINE_CC = 642;
const int ID_UNLOAD_CC_TABLES = 643;
const int ID_USE_CC = 644;
const int ID_ACCEPT_CHANGES = 645;
const int ID_TOOLS_DEFINE_SILCONVERTER = 646;
const int ID_USE_SILCONVERTER = 647;
const int ID_TOOLS_KB_EDITOR = 648;
const int ID_TOOLS_AUTO_CAPITALIZATION = 649;
const int ID_RETRANS_REPORT = 650;
const int ID_TOOLS_SPLIT_DOC = 651;
const int ID_TOOLS_JOIN_DOCS = 652;
const int ID_TOOLS_MOVE_DOC = 653;
const int ID_EXPORT_IMPORT_MENU = 654;
const int ID_FILE_EXPORT_SOURCE = 655;
const int ID_FILE_EXPORT = 656;
const int ID_FILE_EXPORT_TO_RTF = 657;
const int ID_EXPORT_GLOSSES = 658;
const int ID_EXPORT_FREE_TRANS = 659;
const int ID_FILE_EXPORT_KB = 660;
const int ID_IMPORT_TO_KB = 661;
const int ID_MENU_IMPORT_EDITED_SOURCE_TEXT = 662;
const int ID_ADVANCED_MENU = 663;
const int ID_ADVANCED_ENABLEGLOSSING = 664;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 665;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 666;
const int ID_ADVANCED_DELAY = 667;
const int ID_ADVANCED_BOOKMODE = 668;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 669;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 670;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 671;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 672;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 673;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 674;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 675;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 676;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 677;
const int ID_LAYOUT_MENU = 678;
const int ID_ALIGNMENT = 679;
const int ID_HELP_MENU = 680;
const int ID_ONLINE_HELP = 681;
const int ID_REPORT_A_PROBLEM = 682;
const int ID_GIVE_FEEDBACK = 683;
const int ID_HELP_USE_TOOLTIPS = 684;
const int ID_ADMINISTRATOR_MENU = 685;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 686;
const int ID_LOCK_CUSTOM_LOCATION = 687;
const int ID_UNLOCK_CUSTOM_LOCATION = 688;
const int ID_LOCAL_WORK_FOLDER_MENU = 689;
const int ID_SET_PASSWORD_MENU = 690;
const int ID_SETUP_EDITOR_COLLABORATION = 691;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 692;
const int ID_ASSIGN_LOCATIONS_FOR_INPUTS_OUTPUTS = 693;
const int ID_EDIT_USER_MENU_SETTINGS_PROFILE = 694;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_GUESSER = 695;
const int ID_BUTTON_CREATE_NOTE = 696;
const int ID_BUTTON_PREV_NOTE = 697;
const int ID_BUTTON_NEXT_NOTE = 698;
const int ID_BUTTON_DELETE_ALL_NOTES = 699;
const int ID_BUTTON_RESPECTING_BDRY = 700;
const int ID_BUTTON_SHOWING_PUNCT = 701;
const int ID_BUTTON_TO_END = 702;
const int ID_BUTTON_TO_START = 703;
const int ID_BUTTON_STEP_DOWN = 704;
const int ID_BUTTON_STEP_UP = 705;
const int ID_BUTTON_BACK = 706;
const int ID_BUTTON_MERGE = 707;
const int ID_BUTTON_RETRANSLATION = 708;
const int ID_BUTTON_EDIT_RETRANSLATION = 709;
const int ID_REMOVE_RETRANSLATION = 710;
const int ID_BUTTON_NULL_SRC = 711;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 712;
const int ID_BUTTON_CHOOSE_TRANSLATION = 713;
const int ID_SHOWING_ALL = 714;
const int ID_BUTTON_EARLIER_TRANSLATION = 715;
const int ID_BUTTON_NO_PUNCT_COPY = 716;
...
const int ID_BITMAP_FOLDERAI = 717;
const int ID_BITMAP_FILEAI = 718;
const int ID_BITMAP_EMPTY_FOLDER = 719;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 720;
const int ID_BUTTON_HIDING_PUNCT = 721;
const int ID_SHOWING_TGT = 722;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 723;
