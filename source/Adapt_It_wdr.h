...
const int IDC_LIST_OF_COLLAB_PROJECTS = 572;
const int ID_TEXTCTRL_AS_STATIC_IMPORTANT_BOTTOM_NOTE = 573;
const int ID_RADIOBOX_COLLABORATION_ON_OFF = 574;
...
const int ID_TEXTCTRL_AS_STATIC_SELECTED_FREE_TRANS_PROJ = 579;
const int ID_BUTTON_SELECT_FROM_LIST_FREE_TRANS_PROJ = 580;
wxSizer *SetupEditorCollaborationFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_COMBO_SOURCE_PROJECT_NAME = 581;
const int ID_COMBO_DESTINATION_PROJECT_NAME = 582;
const int ID_COMBO_FREE_TRANS_PROJECT_NAME = 583;
const int ID_BUTTON_NO_FREE_TRANS = 584;
const int ID_RADIOBOX_WHOLE_BOOK_OR_CHAPTER = 585;
const int ID_LISTBOX_BOOK_NAMES = 586;
const int ID_TEXT_SELECT_A_CHAPTER = 587;
const int ID_LISTCTRL_CHAPTER_NUMBER_AND_STATUS = 588;
const int ID_TEXTCTRL_AS_STATIC_NOTE = 589;
wxSizer *GetSourceTextFromEditorDlgFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXTCTRL_SOURCE_TEXT_VERSE = 590;
const int ID_TEXTCTRL_AS_STATIC_INSTRUCTIONS = 591;
const int ID_TEXTCTRL_AS_STATIC_EARLIER_FROM = 592;
const int ID_TEXTCTRL_AS_STATIC_RECENT_FROM = 593;
const int ID_TEXTCTRL_EARLIER_VERSION = 594;
const int ID_TEXTCTRL_RECENT_VERSION = 595;
const int ID_BUTTON_USE_EARLIER = 596;
const int ID_BUTTON_USE_RECENT = 597;
...
const int ID_BUTTON_SELECT_ALL_CHECKBOXES = 615;
wxSizer *AssignLocationsForInputsOutputsFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

// Declare menubar functions

const int ID_FILE_MENU = 616;
const int ID_SAVE_AS = 617;
const int ID_FILE_PACK_DOC = 618;
const int ID_FILE_UNPACK_DOC = 619;
const int ID_MENU = 620;
const int ID_FILE_STARTUP_WIZARD = 621;
const int ID_FILE_CLOSEKB = 622;
const int ID_FILE_CHANGEFOLDER = 623;
const int ID_FILE_SAVEKB = 624;
const int ID_FILE_BACKUP_KB = 625;
const int ID_FILE_RESTORE_KB = 626;
const int ID_EDIT_MENU = 627;
const int ID_EDIT_CUT = 628;
const int ID_EDIT_COPY = 629;
const int ID_EDIT_PASTE = 630;
const int ID_GO_TO = 631;
const int ID_EDIT_SOURCE_TEXT = 632;
const int ID_EDIT_CONSISTENCY_CHECK = 633;
const int ID_EDIT_MOVE_NOTE_FORWARD = 634;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 635;
const int ID_VIEW_MENU = 636;
const int ID_VIEW_TOOLBAR = 637;
const int ID_VIEW_STATUS_BAR = 638;
const int ID_VIEW_COMPOSE_BAR = 639;
const int ID_COPY_SOURCE = 640;
const int ID_MARKER_WRAPS_STRIP = 641;
const int ID_UNITS = 642;
const int ID_CHANGE_INTERFACE_LANGUAGE = 643;
const int ID_VIEW_SHOW_ADMIN_MENU = 644;
...
const int ID_SETUP_EDITOR_COLLABORATION = 690;
const int ID_EDIT_USER_MENU_SETTINGS_PROFILE = 691;
const int ID_ASSIGN_LOCATIONS_FOR_INPUTS_OUTPUTS = 692;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 693;
const int ID_SET_PASSWORD_MENU = 694;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 695;
const int ID_LOCK_CUSTOM_LOCATION = 696;
const int ID_UNLOCK_CUSTOM_LOCATION = 697;
const int ID_LOCAL_WORK_FOLDER_MENU = 698;
