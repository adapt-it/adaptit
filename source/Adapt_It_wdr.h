...
const int ID_RADIOBUTTON_TYPE_AORG = 636;
const int ID_TEXTCTRL_TYPED_AORG = 637;
const int ID_CHECK_DO_SAME = 638;
wxSizer *ConsistencyCheck_EmptyNoTU_DlgFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXTCTRL_SOURCE_PHRASE_2 = 639;
const int ID_TEXTCTRL_TARGET_PHRASE_2 = 640;
const int ID_TEXT_EXISTS_STR = 641;
const int ID_RADIO_STORE_NORMALLY = 642;
const int ID_RADIO_NOT_IN_KB_LEAVEINDOC = 643;
const int ID_CHECK_DO_SAME2 = 644;
wxSizer *ConsistencyCheck_ExistsNoTU_DlgFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_BITMAPBUTTON_MOVE_BACK = 645;
const int ID_BITMAPBUTTON_MOVE_FORWARD = 646;
const int ID_BUTTON_OPEN_HTML_FILE = 647;
const int ID_TEXTCTRL_HTML_FILE_PATH = 648;
const int ID_HTML_WINDOW = 649;
wxSizer *HtmlFileViewerDlgFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

// Declare menubar functions

const int ID_FILE_MENU = 650;
const int ID_SAVE_AS = 651;
const int ID_FILE_PACK_DOC = 652;
const int ID_FILE_UNPACK_DOC = 653;
const int ID_MENU = 654;
const int ID_FILE_STARTUP_WIZARD = 655;
const int ID_FILE_CLOSEKB = 656;
const int ID_FILE_CHANGEFOLDER = 657;
const int ID_FILE_SAVEKB = 658;
const int ID_FILE_BACKUP_KB = 659;
const int ID_FILE_RESTORE_KB = 660;
const int ID_EDIT_MENU = 661;
const int ID_EDIT_CUT = 662;
const int ID_EDIT_COPY = 663;
const int ID_EDIT_PASTE = 664;
const int ID_GO_TO = 665;
const int ID_EDIT_SOURCE_TEXT = 666;
const int ID_EDIT_CONSISTENCY_CHECK = 667;
const int ID_EDIT_MOVE_NOTE_FORWARD = 668;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 669;
const int ID_VIEW_MENU = 670;
const int ID_VIEW_TOOLBAR = 671;
const int ID_VIEW_STATUS_BAR = 672;
const int ID_VIEW_COMPOSE_BAR = 673;
const int ID_COPY_SOURCE = 674;
const int ID_MARKER_WRAPS_STRIP = 675;
const int ID_UNITS = 676;
const int ID_CHANGE_INTERFACE_LANGUAGE = 677;
const int ID_VIEW_SHOW_ADMIN_MENU = 678;
const int ID_TOOLS_MENU = 679;
const int ID_TOOLS_DEFINE_CC = 680;
const int ID_UNLOAD_CC_TABLES = 681;
const int ID_USE_CC = 682;
const int ID_ACCEPT_CHANGES = 683;
const int ID_TOOLS_DEFINE_SILCONVERTER = 684;
const int ID_USE_SILCONVERTER = 685;
const int ID_TOOLS_KB_EDITOR = 686;
const int ID_TOOLS_AUTO_CAPITALIZATION = 687;
const int ID_RETRANS_REPORT = 688;
const int ID_TOOLS_SPLIT_DOC = 689;
const int ID_TOOLS_JOIN_DOCS = 690;
const int ID_TOOLS_MOVE_DOC = 691;
const int ID_EXPORT_IMPORT_MENU = 692;
const int ID_FILE_EXPORT_SOURCE = 693;
const int ID_FILE_EXPORT = 694;
const int ID_FILE_EXPORT_TO_RTF = 695;
const int ID_EXPORT_GLOSSES = 696;
const int ID_EXPORT_FREE_TRANS = 697;
const int ID_FILE_EXPORT_KB = 698;
const int ID_IMPORT_TO_KB = 699;
const int ID_MENU_IMPORT_EDITED_SOURCE_TEXT = 700;
const int ID_ADVANCED_MENU = 701;
const int ID_ADVANCED_SEE_GLOSSES = 702;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 703;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 704;
const int ID_ADVANCED_DELAY = 705;
const int ID_ADVANCED_BOOKMODE = 706;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 707;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 708;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 709;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 710;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 711;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 712;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 713;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 714;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 715;
const int ID_LAYOUT_MENU = 716;
const int ID_ALIGNMENT = 717;
const int ID_HELP_MENU = 718;
const int ID_ONLINE_HELP = 719;
const int ID_REPORT_A_PROBLEM = 720;
const int ID_GIVE_FEEDBACK = 721;
const int ID_HELP_USE_TOOLTIPS = 722;
const int ID_ADMINISTRATOR_MENU = 723;
const int ID_MENU_HELP_FOR_ADMINISTRATORS = 724;
