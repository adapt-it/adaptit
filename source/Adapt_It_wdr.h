...
const int ID_RADIOBOX_PT_COLLABORATION_ON_OFF = 575;
...
const int ID_COMBO_SOURCE_PT_PROJECT_NAME = 580;
const int ID_COMBO_DESTINATION_PT_PROJECT_NAME = 581;
...
const int ID_TEXTCTRL_SOURCE_TEXT_VERSE = 587;
const int ID_TEXTCTRL_AS_STATIC_INSTRUCTIONS = 588;
const int ID_TEXTCTRL_AS_STATIC_EARLIER_FROM = 589;
const int ID_TEXTCTRL_AS_STATIC_RECENT_FROM = 590;
const int ID_TEXTCTRL_EARLIER_VERSION = 591;
const int ID_TEXTCTRL_RECENT_VERSION = 592;
const int ID_BUTTON_USE_EARLIER = 593;
const int ID_BUTTON_USE_RECENT = 594;
wxSizer *ConflictResolutionDlgFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXTCTRL_AS_STATIC_TOP_INFO = 595;
const int ID_CHECKBOX_PROTECT_SOURCE_INPUTS = 596;
const int ID_BUTTON_PRE_LOAD_SOURCE_TEXTS = 597;
const int ID_CHECKBOX_PROTECT_FREETRANS_OUTPUTS = 598;
const int ID_CHECKBOX_PROTECT_FREETRANS_RTF_OUTPUTS = 599;
const int ID_CHECKBOX_PROTECT_GLOSS_OUTPUTS = 600;
const int ID_CHECKBOX_PROTECT_GLOSS_RTF_OUTPUTS = 601;
const int ID_CHECKBOX_PROTECT_INTERLINEAR_RTF_OUTPUTS = 602;
const int ID_CHECKBOX_PROTECT_SOURCE_OUTPUTS = 603;
const int ID_CHECKBOX_PROTECT_SOURCE_RTF_OUTPUTS = 604;
const int ID_CHECKBOX_PROTECT_TARGET_OUTPUTS = 605;
const int ID_CHECKBOX_PROTECT_TARGET_RTF_OUTPUTS = 606;
const int ID_CHECKBOX_PROTECT_KB_INPUTS_AND_OUTPUTS = 607;
const int ID_CHECKBOX_PROTECT_LIFT_INPUTS_AND_OUTPUTS = 608;
const int ID_BUTTON_SELECT_ALL_CHECKBOXES = 609;
wxSizer *AssignLocationsForInputsOutputsFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

// Declare menubar functions

const int ID_FILE_MENU = 610;
const int ID_SAVE_AS = 611;
const int ID_FILE_PACK_DOC = 612;
const int ID_FILE_UNPACK_DOC = 613;
const int ID_MENU = 614;
const int ID_FILE_STARTUP_WIZARD = 615;
const int ID_FILE_CLOSEKB = 616;
const int ID_FILE_CHANGEFOLDER = 617;
const int ID_FILE_SAVEKB = 618;
const int ID_FILE_BACKUP_KB = 619;
const int ID_FILE_RESTORE_KB = 620;
const int ID_EDIT_MENU = 621;
const int ID_EDIT_CUT = 622;
const int ID_EDIT_COPY = 623;
const int ID_EDIT_PASTE = 624;
const int ID_GO_TO = 625;
const int ID_EDIT_SOURCE_TEXT = 626;
const int ID_EDIT_CONSISTENCY_CHECK = 627;
const int ID_EDIT_MOVE_NOTE_FORWARD = 628;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 629;
const int ID_VIEW_MENU = 630;
const int ID_VIEW_TOOLBAR = 631;
const int ID_VIEW_STATUS_BAR = 632;
const int ID_VIEW_COMPOSE_BAR = 633;
const int ID_COPY_SOURCE = 634;
const int ID_MARKER_WRAPS_STRIP = 635;
const int ID_UNITS = 636;
const int ID_CHANGE_INTERFACE_LANGUAGE = 637;
const int ID_TOOLS_MENU = 638;
const int ID_TOOLS_DEFINE_CC = 639;
const int ID_UNLOAD_CC_TABLES = 640;
const int ID_USE_CC = 641;
const int ID_ACCEPT_CHANGES = 642;
const int ID_TOOLS_DEFINE_SILCONVERTER = 643;
const int ID_USE_SILCONVERTER = 644;
const int ID_TOOLS_KB_EDITOR = 645;
const int ID_TOOLS_AUTO_CAPITALIZATION = 646;
const int ID_RETRANS_REPORT = 647;
const int ID_TOOLS_SPLIT_DOC = 648;
const int ID_TOOLS_JOIN_DOCS = 649;
const int ID_TOOLS_MOVE_DOC = 650;
const int ID_EXPORT_IMPORT_MENU = 651;
const int ID_FILE_EXPORT_SOURCE = 652;
const int ID_FILE_EXPORT = 653;
const int ID_FILE_EXPORT_TO_RTF = 654;
const int ID_EXPORT_GLOSSES = 655;
const int ID_EXPORT_FREE_TRANS = 656;
const int ID_FILE_EXPORT_KB = 657;
const int ID_IMPORT_TO_KB = 658;
const int ID_MENU_IMPORT_EDITED_SOURCE_TEXT = 659;
const int ID_ADVANCED_MENU = 660;
const int ID_ADVANCED_ENABLEGLOSSING = 661;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 662;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 663;
const int ID_ADVANCED_DELAY = 664;
const int ID_ADVANCED_BOOKMODE = 665;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 666;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 667;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 668;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 669;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 670;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 671;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 672;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 673;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 674;
const int ID_LAYOUT_MENU = 675;
const int ID_ALIGNMENT = 676;
const int ID_HELP_MENU = 677;
const int ID_ONLINE_HELP = 678;
const int ID_REPORT_A_PROBLEM = 679;
const int ID_GIVE_FEEDBACK = 680;
const int ID_HELP_USE_TOOLTIPS = 681;
const int ID_ADMINISTRATOR_MENU = 682;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 683;
const int ID_LOCK_CUSTOM_LOCATION = 684;
const int ID_UNLOCK_CUSTOM_LOCATION = 685;
const int ID_LOCAL_WORK_FOLDER_MENU = 686;
const int ID_SET_PASSWORD_MENU = 687;
const int ID_SETUP_EDITOR_COLLABORATION = 688;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 689;
const int ID_ASSIGN_LOCATIONS_FOR_INPUTS_OUTPUTS = 690;
const int ID_EDIT_USER_MENU_SETTINGS_PROFILE = 691;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_GUESSER = 692;
const int ID_BUTTON_CREATE_NOTE = 693;
const int ID_BUTTON_PREV_NOTE = 694;
const int ID_BUTTON_NEXT_NOTE = 695;
const int ID_BUTTON_DELETE_ALL_NOTES = 696;
const int ID_BUTTON_RESPECTING_BDRY = 697;
const int ID_BUTTON_SHOWING_PUNCT = 698;
const int ID_BUTTON_TO_END = 699;
const int ID_BUTTON_TO_START = 700;
const int ID_BUTTON_STEP_DOWN = 701;
const int ID_BUTTON_STEP_UP = 702;
const int ID_BUTTON_BACK = 703;
const int ID_BUTTON_MERGE = 704;
const int ID_BUTTON_RETRANSLATION = 705;
const int ID_BUTTON_EDIT_RETRANSLATION = 706;
const int ID_REMOVE_RETRANSLATION = 707;
const int ID_BUTTON_NULL_SRC = 708;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 709;
const int ID_BUTTON_CHOOSE_TRANSLATION = 710;
const int ID_SHOWING_ALL = 711;
const int ID_BUTTON_EARLIER_TRANSLATION = 712;
const int ID_BUTTON_NO_PUNCT_COPY = 713;
...
const int ID_BITMAP_FOLDERAI = 714;
const int ID_BITMAP_FILEAI = 715;
const int ID_BITMAP_EMPTY_FOLDER = 716;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 717;
const int ID_BUTTON_HIDING_PUNCT = 718;
const int ID_SHOWING_TGT = 719;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 720;
