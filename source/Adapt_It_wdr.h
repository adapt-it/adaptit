...
const int ID_FILE_MENU = 651;
const int ID_SAVE_AS = 652;
const int ID_FILE_PACK_DOC = 653;
const int ID_FILE_UNPACK_DOC = 654;
const int ID_MENU = 655;
const int ID_FILE_STARTUP_WIZARD = 656;
const int ID_FILE_CLOSEKB = 657;
const int ID_FILE_CHANGEFOLDER = 658;
const int ID_FILE_SAVEKB = 659;
const int ID_FILE_BACKUP_KB = 660;
const int ID_FILE_RESTORE_KB = 661;
const int ID_EDIT_MENU = 662;
const int ID_EDIT_CUT = 663;
const int ID_EDIT_COPY = 664;
const int ID_EDIT_PASTE = 665;
const int ID_GO_TO = 666;
const int ID_EDIT_SOURCE_TEXT = 667;
const int ID_EDIT_CONSISTENCY_CHECK = 668;
const int ID_EDIT_MOVE_NOTE_FORWARD = 669;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 670;
const int ID_VIEW_MENU = 671;
const int ID_VIEW_TOOLBAR = 672;
const int ID_VIEW_STATUS_BAR = 673;
const int ID_VIEW_COMPOSE_BAR = 674;
const int ID_COPY_SOURCE = 675;
const int ID_MARKER_WRAPS_STRIP = 676;
const int ID_UNITS = 677;
const int ID_CHANGE_INTERFACE_LANGUAGE = 678;
const int ID_VIEW_SHOW_ADMIN_MENU = 679;
const int ID_TOOLS_MENU = 680;
const int ID_TOOLS_DEFINE_CC = 681;
const int ID_UNLOAD_CC_TABLES = 682;
const int ID_USE_CC = 683;
const int ID_ACCEPT_CHANGES = 684;
const int ID_TOOLS_DEFINE_SILCONVERTER = 685;
const int ID_USE_SILCONVERTER = 686;
const int ID_TOOLS_KB_EDITOR = 687;
const int ID_TOOLS_AUTO_CAPITALIZATION = 688;
const int ID_RETRANS_REPORT = 689;
const int ID_TOOLS_SPLIT_DOC = 690;
const int ID_TOOLS_JOIN_DOCS = 691;
const int ID_TOOLS_MOVE_DOC = 692;
const int ID_EXPORT_IMPORT_MENU = 693;
const int ID_FILE_EXPORT_SOURCE = 694;
const int ID_FILE_EXPORT = 695;
const int ID_FILE_EXPORT_TO_RTF = 696;
const int ID_EXPORT_GLOSSES = 697;
const int ID_EXPORT_FREE_TRANS = 698;
const int ID_FILE_EXPORT_KB = 699;
const int ID_IMPORT_TO_KB = 700;
const int ID_MENU_IMPORT_EDITED_SOURCE_TEXT = 701;
const int ID_ADVANCED_MENU = 702;
const int ID_ADVANCED_SEE_GLOSSES = 703;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 704;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 705;
const int ID_ADVANCED_DELAY = 706;
const int ID_ADVANCED_BOOKMODE = 707;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 708;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 709;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 710;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 711;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 712;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 713;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 714;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 715;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 716;
const int ID_LAYOUT_MENU = 717;
const int ID_ALIGNMENT = 718;
const int ID_HELP_MENU = 719;
const int ID_MENU_AI_QUICK_START = 720;
const int ID_REPORT_A_PROBLEM = 721;
const int ID_GIVE_FEEDBACK = 722;
const int ID_HELP_USE_TOOLTIPS = 723;
const int ID_ADMINISTRATOR_MENU = 724;
const int ID_MENU_HELP_FOR_ADMINISTRATORS = 725;
const int ID_SETUP_EDITOR_COLLABORATION = 726;
const int ID_EDIT_USER_MENU_SETTINGS_PROFILE = 727;
const int ID_ASSIGN_LOCATIONS_FOR_INPUTS_OUTPUTS = 728;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 729;
const int ID_SET_PASSWORD_MENU = 730;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 731;
const int ID_LOCK_CUSTOM_LOCATION = 732;
const int ID_UNLOCK_CUSTOM_LOCATION = 733;
const int ID_LOCAL_WORK_FOLDER_MENU = 734;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_GUESSER = 735;
const int ID_BUTTON_CREATE_NOTE = 736;
const int ID_BUTTON_PREV_NOTE = 737;
const int ID_BUTTON_NEXT_NOTE = 738;
const int ID_BUTTON_DELETE_ALL_NOTES = 739;
const int ID_BUTTON_RESPECTING_BDRY = 740;
const int ID_BUTTON_SHOWING_PUNCT = 741;
const int ID_BUTTON_TO_END = 742;
const int ID_BUTTON_TO_START = 743;
const int ID_BUTTON_STEP_DOWN = 744;
const int ID_BUTTON_STEP_UP = 745;
const int ID_BUTTON_BACK = 746;
const int ID_BUTTON_MERGE = 747;
const int ID_BUTTON_RETRANSLATION = 748;
const int ID_BUTTON_EDIT_RETRANSLATION = 749;
const int ID_REMOVE_RETRANSLATION = 750;
const int ID_BUTTON_NULL_SRC = 751;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 752;
const int ID_BUTTON_CHOOSE_TRANSLATION = 753;
const int ID_SHOWING_ALL = 754;
const int ID_BUTTON_EARLIER_TRANSLATION = 755;
const int ID_BUTTON_NO_PUNCT_COPY = 756;
...
const int ID_BITMAP_FOLDERAI = 757;
const int ID_BITMAP_FILEAI = 758;
const int ID_BITMAP_EMPTY_FOLDER = 759;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 760;
const int ID_BUTTON_HIDING_PUNCT = 761;
const int ID_SHOWING_TGT = 762;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 763;
