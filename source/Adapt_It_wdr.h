...
const int ID_FILE_MENU = 645;
const int ID_SAVE_AS = 646;
const int ID_FILE_PACK_DOC = 647;
const int ID_FILE_UNPACK_DOC = 648;
const int ID_MENU = 649;
const int ID_FILE_STARTUP_WIZARD = 650;
const int ID_FILE_CLOSEKB = 651;
const int ID_FILE_CHANGEFOLDER = 652;
const int ID_FILE_SAVEKB = 653;
const int ID_FILE_BACKUP_KB = 654;
const int ID_FILE_RESTORE_KB = 655;
const int ID_EDIT_MENU = 656;
const int ID_EDIT_CUT = 657;
const int ID_EDIT_COPY = 658;
const int ID_EDIT_PASTE = 659;
const int ID_GO_TO = 660;
const int ID_EDIT_SOURCE_TEXT = 661;
const int ID_EDIT_CONSISTENCY_CHECK = 662;
const int ID_EDIT_MOVE_NOTE_FORWARD = 663;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 664;
const int ID_VIEW_MENU = 665;
const int ID_VIEW_TOOLBAR = 666;
const int ID_VIEW_STATUS_BAR = 667;
const int ID_VIEW_COMPOSE_BAR = 668;
const int ID_COPY_SOURCE = 669;
const int ID_MARKER_WRAPS_STRIP = 670;
const int ID_UNITS = 671;
const int ID_CHANGE_INTERFACE_LANGUAGE = 672;
const int ID_VIEW_SHOW_ADMIN_MENU = 673;
const int ID_TOOLS_MENU = 674;
const int ID_TOOLS_DEFINE_CC = 675;
const int ID_UNLOAD_CC_TABLES = 676;
const int ID_USE_CC = 677;
const int ID_ACCEPT_CHANGES = 678;
const int ID_TOOLS_DEFINE_SILCONVERTER = 679;
const int ID_USE_SILCONVERTER = 680;
const int ID_TOOLS_KB_EDITOR = 681;
const int ID_TOOLS_AUTO_CAPITALIZATION = 682;
const int ID_RETRANS_REPORT = 683;
const int ID_TOOLS_SPLIT_DOC = 684;
const int ID_TOOLS_JOIN_DOCS = 685;
const int ID_TOOLS_MOVE_DOC = 686;
const int ID_EXPORT_IMPORT_MENU = 687;
const int ID_FILE_EXPORT_SOURCE = 688;
const int ID_FILE_EXPORT = 689;
const int ID_FILE_EXPORT_TO_RTF = 690;
const int ID_EXPORT_GLOSSES = 691;
const int ID_EXPORT_FREE_TRANS = 692;
const int ID_FILE_EXPORT_KB = 693;
const int ID_IMPORT_TO_KB = 694;
const int ID_MENU_IMPORT_EDITED_SOURCE_TEXT = 695;
const int ID_ADVANCED_MENU = 696;
const int ID_ADVANCED_SEE_GLOSSES = 697;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 698;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 699;
const int ID_ADVANCED_DELAY = 700;
const int ID_ADVANCED_BOOKMODE = 701;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 702;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 703;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 704;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 705;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 706;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 707;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 708;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 709;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 710;
const int ID_LAYOUT_MENU = 711;
const int ID_ALIGNMENT = 712;
const int ID_HELP_MENU = 713;
const int ID_ONLINE_HELP = 714;
const int ID_REPORT_A_PROBLEM = 715;
const int ID_GIVE_FEEDBACK = 716;
const int ID_HELP_USE_TOOLTIPS = 717;
const int ID_ADMINISTRATOR_MENU = 718;
const int ID_MENU_HELP_FOR_ADMINISTRATORS = 719;
const int ID_SETUP_EDITOR_COLLABORATION = 720;
const int ID_EDIT_USER_MENU_SETTINGS_PROFILE = 721;
const int ID_ASSIGN_LOCATIONS_FOR_INPUTS_OUTPUTS = 722;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 723;
const int ID_SET_PASSWORD_MENU = 724;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 725;
const int ID_LOCK_CUSTOM_LOCATION = 726;
const int ID_UNLOCK_CUSTOM_LOCATION = 727;
const int ID_LOCAL_WORK_FOLDER_MENU = 728;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_GUESSER = 729;
const int ID_BUTTON_CREATE_NOTE = 730;
const int ID_BUTTON_PREV_NOTE = 731;
const int ID_BUTTON_NEXT_NOTE = 732;
const int ID_BUTTON_DELETE_ALL_NOTES = 733;
const int ID_BUTTON_RESPECTING_BDRY = 734;
const int ID_BUTTON_SHOWING_PUNCT = 735;
const int ID_BUTTON_TO_END = 736;
const int ID_BUTTON_TO_START = 737;
const int ID_BUTTON_STEP_DOWN = 738;
const int ID_BUTTON_STEP_UP = 739;
const int ID_BUTTON_BACK = 740;
const int ID_BUTTON_MERGE = 741;
const int ID_BUTTON_RETRANSLATION = 742;
const int ID_BUTTON_EDIT_RETRANSLATION = 743;
const int ID_REMOVE_RETRANSLATION = 744;
const int ID_BUTTON_NULL_SRC = 745;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 746;
const int ID_BUTTON_CHOOSE_TRANSLATION = 747;
const int ID_SHOWING_ALL = 748;
const int ID_BUTTON_EARLIER_TRANSLATION = 749;
const int ID_BUTTON_NO_PUNCT_COPY = 750;
...
const int ID_BITMAP_FOLDERAI = 751;
const int ID_BITMAP_FILEAI = 752;
const int ID_BITMAP_EMPTY_FOLDER = 753;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 754;
const int ID_BUTTON_HIDING_PUNCT = 755;
const int ID_SHOWING_TGT = 756;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 757;
