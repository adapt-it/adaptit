...
const int ID_TEXT_STATIC_SELECT_WHICH_PROJECTS = 577;
const int ID_TEXT_STATIC_SELECT_THIRD_PROJECT = 578;
const int ID_TEXT_STATIC_SRC_FROM_THIS_PROJECT = 579;
const int ID_TEXTCTRL_AS_STATIC_SELECTED_SRC_PROJ = 580;
const int ID_BUTTON_SELECT_FROM_LIST_SOURCE_PROJ = 581;
const int ID_TEXT_STATIC_TARGET_TO_THIS_PROJECT = 582;
const int ID_TEXTCTRL_AS_STATIC_SELECTED_TGT_PROJ = 583;
const int ID_BUTTON_SELECT_FROM_LIST_TARGET_PROJ = 584;
const int ID_TEXT_STATIC_TO_THIS_FT_PROJECT = 585;
const int ID_TEXTCTRL_AS_STATIC_SELECTED_FREE_TRANS_PROJ = 586;
const int ID_BUTTON_SELECT_FROM_LIST_FREE_TRANS_PROJ = 587;
const int ID_COMBO_AI_PROJECTS = 588;
const int ID_TEXT_EXISTS_OR_WILL_BE_CREATED = 589;
const int ID_TEXT_SRC_NAME_LABEL = 590;
const int ID_TEXTCTRL_SRC_LANG_NAME = 591;
const int ID_RADIOBOX_COLLABORATION_ON_OFF = 592;
const int ID_TEXT_AS_STATIC_NEW_AI_PROJ_NAME = 593;
const int ID_TEXT_TGT_NAME_LABEL = 594;
const int ID_TEXTCTRL_TGT_LANG_NAME = 595;
const int ID_TEXTCTRL_NEW_AI_PROJ_NAME = 596;
wxSizer *SetupEditorCollaborationFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_RADIOBOX_WHOLE_BOOK_OR_CHAPTER = 597;
...
const int ID_COMBO_SOURCE_PROJECT_NAME = 602;
const int ID_COMBO_DESTINATION_PROJECT_NAME = 603;
const int ID_COMBO_FREE_TRANS_PROJECT_NAME = 604;
const int ID_BUTTON_NO_FREE_TRANS = 605;
const int ID_TEXT_ENTER_LANG_NAME = 606;
wxSizer *GetSourceTextFromEditorDlgFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXTCTRL_SOURCE_TEXT_VERSE = 607;
const int ID_TEXTCTRL_AS_STATIC_INSTRUCTIONS = 608;
const int ID_TEXTCTRL_AS_STATIC_EARLIER_FROM = 609;
const int ID_TEXTCTRL_AS_STATIC_RECENT_FROM = 610;
const int ID_TEXTCTRL_EARLIER_VERSION = 611;
const int ID_TEXTCTRL_RECENT_VERSION = 612;
const int ID_BUTTON_USE_EARLIER = 613;
const int ID_BUTTON_USE_RECENT = 614;
...
const int ID_BUTTON_SELECT_ALL_CHECKBOXES = 632;
wxSizer *AssignLocationsForInputsOutputsFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXTCTRL_SOURCE_PHRASE_1 = 633;
const int ID_TEXT_EMPTY_STR = 634;
const int ID_RADIO_NO_ADAPTATION = 635;
const int ID_RADIO_LEAVE_HOLE = 636;
const int ID_RADIO_NOT_IN_KB = 637;
...
const int ID_SETUP_EDITOR_COLLABORATION = 719;
const int ID_EDIT_USER_MENU_SETTINGS_PROFILE = 720;
const int ID_ASSIGN_LOCATIONS_FOR_INPUTS_OUTPUTS = 721;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 722;
const int ID_SET_PASSWORD_MENU = 723;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 724;
const int ID_LOCK_CUSTOM_LOCATION = 725;
const int ID_UNLOCK_CUSTOM_LOCATION = 726;
const int ID_LOCAL_WORK_FOLDER_MENU = 727;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_GUESSER = 728;
const int ID_BUTTON_CREATE_NOTE = 729;
const int ID_BUTTON_PREV_NOTE = 730;
const int ID_BUTTON_NEXT_NOTE = 731;
const int ID_BUTTON_DELETE_ALL_NOTES = 732;
const int ID_BUTTON_RESPECTING_BDRY = 733;
const int ID_BUTTON_SHOWING_PUNCT = 734;
const int ID_BUTTON_TO_END = 735;
const int ID_BUTTON_TO_START = 736;
const int ID_BUTTON_STEP_DOWN = 737;
const int ID_BUTTON_STEP_UP = 738;
const int ID_BUTTON_BACK = 739;
const int ID_BUTTON_MERGE = 740;
const int ID_BUTTON_RETRANSLATION = 741;
const int ID_BUTTON_EDIT_RETRANSLATION = 742;
const int ID_REMOVE_RETRANSLATION = 743;
const int ID_BUTTON_NULL_SRC = 744;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 745;
const int ID_BUTTON_CHOOSE_TRANSLATION = 746;
const int ID_SHOWING_ALL = 747;
const int ID_BUTTON_EARLIER_TRANSLATION = 748;
const int ID_BUTTON_NO_PUNCT_COPY = 749;
...
const int ID_BITMAP_FOLDERAI = 750;
const int ID_BITMAP_FILEAI = 751;
const int ID_BITMAP_EMPTY_FOLDER = 752;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 753;
const int ID_BUTTON_HIDING_PUNCT = 754;
const int ID_SHOWING_TGT = 755;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 756;
