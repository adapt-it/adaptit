...
void* Thread_ChangedSince::Entry()
{
	...
	{
		wxString msg;
		msg = msg.Format(_("Periodic download of new entries failed. Error code: %d \nProbably nothing was downloaded to the local knowledge base. \n You can ignore this, but if it happens often, seek help to find out why it is happening."),
			rv);
