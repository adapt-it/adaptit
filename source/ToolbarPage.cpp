...
void CToolbarPagePrefs::PopulateList()
{
	...
	ToolbarButtonInfo tbInfo[] =
	{
		...
		{0, _T(""), _T(""), _T(""), wxNullBitmap, wxNullBitmap, wxNullBitmap},
		{ID_BUTTON_RETRANSLATION, _("New Retrans"), _("Do A Retranslation"), _("The selected section is a retranslation, not an adaptation"), gpApp->wxGetBitmapFromMemory(retranslation_new_png_16), wxNullBitmap, wxNullBitmap},
		{ID_BUTTON_EDIT_RETRANSLATION, _("Edit Retrans"), _("Edit A Retranslation"), _("Edit the retranslation at the selection or at the active location"), gpApp->wxGetBitmapFromMemory(retranslation_edit_png_16), wxNullBitmap, wxNullBitmap},
		{ID_REMOVE_RETRANSLATION, _("Delete Retrans"), _("Remove A Retranslation"), _("Remove the whole of the retranslation"), gpApp->wxGetBitmapFromMemory(retranslation_delete_png_16), wxNullBitmap, wxNullBitmap},
		{0, _T(""), _T(""), _T(""), wxNullBitmap, wxNullBitmap, wxNullBitmap},
        {ID_BUTTON_NULL_SRC_LEFT, _("... Left"), _("Insert A Placeholder to Left of Selection/PhraseBox"), _("Insert a placeholder into the source language text to the left of any selection or the phrasebox location"), gpApp->wxGetBitmapFromMemory(insplaceholder_left_png_16), wxNullBitmap, wxNullBitmap },
        {ID_BUTTON_NULL_SRC_RIGHT, _("... Right"), _("Insert A Placeholder to Right of Selection/PhraseBox"), _("Insert a placeholder into the source language text to the right of any selection or the phrasebox location"), gpApp->wxGetBitmapFromMemory(insplaceholder_right_png_16), wxNullBitmap, wxNullBitmap },
        {ID_BUTTON_REMOVE_NULL_SRCPHRASE, _("Delete ..."), _("Remove A Placeholder"), _("Restore selected phrase to a sequence of word objects"), gpApp->wxGetBitmapFromMemory(placeholder_delete_png_16), wxNullBitmap, wxNullBitmap},
		{0, _T(""), _T(""), _T(""), wxNullBitmap, wxNullBitmap, wxNullBitmap},
