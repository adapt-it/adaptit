...
void CToolbarPagePrefs::PopulateList()
{
	...
	ToolbarButtonInfo tbInfo[] =
	{
		...
		{0, _T(""), _T(""), _T(""), wxNullBitmap, wxNullBitmap, wxNullBitmap},
        {ID_BUTTON_NULL_SRC_LEFT, _("New Placeholder Left"), _("Insert A Placeholder to Left of Selection/PhraseBox"), _("Insert a placeholder into the source language text to the left of any selection or the phrasebox location"), gpApp->wxGetBitmapFromMemory(insplaceholder_left_png_16), wxNullBitmap, wxNullBitmap },
        {ID_BUTTON_NULL_SRC_RIGHT, _("New Placeholder Right"), _("Insert A Placeholder to Right of Selection/PhraseBox"), _("Insert a placeholder into the source language text to the right of any selection or the phrasebox location"), gpApp->wxGetBitmapFromMemory(insplaceholder_right_png_16), wxNullBitmap, wxNullBitmap },
