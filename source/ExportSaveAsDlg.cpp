		...
		wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER)
{
	...
	BoxSizer1->Add(lblExportTo, 1, wxALL|wxALIGN_RIGHT, 10);
	...
	BoxSizer1->Add(btnExportToTxt, 1, wxALL|wxALIGN_CENTER, 5);
	...
	BoxSizer1->Add(btnExportToRtf, 1, wxALL|wxALIGN_CENTER, 5);
	...
	BoxSizer1->Add(btnExportToXhtml, 1, wxALL|wxALIGN_CENTER, 5);
	...
	BoxSizer1->Add(btnExportToPathway, 1, wxALL|wxALIGN_CENTER, 5);
	BoxSizer1->Add(-1,-1,1, wxALL|wxALIGN_CENTER, 5);
