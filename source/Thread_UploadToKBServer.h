/////////////////////////////////////////////////////////////////////////////
/// \project		adaptit
/// \file			Thread_UploadToKBServer.h
/// \author			Bruce Waters
...
#ifndef Thread_UploadToKBServer_h
#define Thread_UploadToKBServer_h
...
class Thread_UploadToKBServer : public wxThread
{
public:
	Thread_UploadToKBServer(); // creator
	virtual ~Thread_UploadToKBServer(void); // destructor
