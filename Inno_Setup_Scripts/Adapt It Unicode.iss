...
OutputBaseFilename=Adapt_It_WX_6_9_0_Unicode
...
VersionInfoProductVersion=6.9.0
...
Source: "{#SvnBase}\setup Git\Git_Downloader_2_12_1_4AI.exe"; DestDir: "{app}"; Flags: ignoreversion; 
