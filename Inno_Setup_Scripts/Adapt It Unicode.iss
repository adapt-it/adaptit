...
; which creates a special Git_2_12_1_4AI.exe installer that is now included in the [Files]
; section below. The Git_2_12_1_4AI.exe installer is used by the main Adapt It program
...
OutputBaseFilename=Adapt_It_WX_6_8_2_Unicode
...
VersionInfoProductVersion=6.8.2
...
Source: "{#SvnBase}\setup Git\Git_2_12_1_4AI.exe"; DestDir: "{app}"; Flags: ignoreversion; 
...
//const GitSetupURL64 = 'https://github.com/git-for-windows/git/releases/download/v2.6.2.windows.1/Git-2.6.2-64-bit.exe';
  Btn1Desc = 'I will use Adapt It without Git, or I will install Git later.';
