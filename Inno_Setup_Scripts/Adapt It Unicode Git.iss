; IMPORTANT: RUN THis Adapt It Unicode Git.iss SCRIPT TO CREATE Git_Downloader2_18_0_4AI.exe
...
#define MyAppExeName "Git_Downloader_2_18_0_4AI.exe"
...
LicenseFile=
InfoBeforeFile=
OutputBaseFilename=Git_Downloader_2_18_0_4AI
...
VersionInfoProductVersion=2.18.0
WizardImageFile="{#SvnBase}\res\ai_wiz_bg.bmp"
WizardSmallImageFile="{#SvnBase}\res\AILogo32x32.bmp"
WizardImageStretch=false
AppCopyright=2018 Bruce Waters, Bill Martin, SIL International
PrivilegesRequired=poweruser
DirExistsWarning=no
VersionInfoVersion=2.18.0
VersionInfoCompany=
...
const 
  GitInstallerFileName = 'Git-2.18.0-32-bit.exe';
