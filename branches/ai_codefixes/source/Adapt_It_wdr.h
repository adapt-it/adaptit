...
const int ID_FILE_MENU = 532;
const int ID_SAVE_AS = 533;
const int ID_FILE_PACK_DOC = 534;
const int ID_FILE_UNPACK_DOC = 535;
const int ID_MENU = 536;
const int ID_FILE_STARTUP_WIZARD = 537;
const int ID_FILE_CLOSEKB = 538;
const int ID_FILE_CHANGEFOLDER = 539;
const int ID_FILE_SAVEKB = 540;
const int ID_FILE_BACKUP_KB = 541;
const int ID_FILE_RESTORE_KB = 542;
const int ID_EDIT_MENU = 543;
const int ID_EDIT_CUT = 544;
const int ID_EDIT_COPY = 545;
const int ID_EDIT_PASTE = 546;
const int ID_GO_TO = 547;
const int ID_EDIT_SOURCE_TEXT = 548;
const int ID_EDIT_CONSISTENCY_CHECK = 549;
const int ID_EDIT_MOVE_NOTE_FORWARD = 550;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 551;
const int ID_VIEW_MENU = 552;
const int ID_VIEW_TOOLBAR = 553;
const int ID_VIEW_STATUS_BAR = 554;
const int ID_VIEW_COMPOSE_BAR = 555;
const int ID_COPY_SOURCE = 556;
const int ID_MARKER_WRAPS_STRIP = 557;
const int ID_UNITS = 558;
const int ID_CHANGE_INTERFACE_LANGUAGE = 559;
const int ID_TOOLS_MENU = 560;
const int ID_TOOLS_DEFINE_CC = 561;
const int ID_UNLOAD_CC_TABLES = 562;
const int ID_USE_CC = 563;
const int ID_ACCEPT_CHANGES = 564;
const int ID_TOOLS_DEFINE_SILCONVERTER = 565;
const int ID_USE_SILCONVERTER = 566;
const int ID_TOOLS_KB_EDITOR = 567;
const int ID_TOOLS_AUTO_CAPITALIZATION = 568;
const int ID_RETRANS_REPORT = 569;
const int ID_TOOLS_SPLIT_DOC = 570;
const int ID_TOOLS_JOIN_DOCS = 571;
const int ID_TOOLS_MOVE_DOC = 572;
const int ID_EXPORT_IMPORT_MENU = 573;
const int ID_FILE_EXPORT_SOURCE = 574;
const int ID_FILE_EXPORT = 575;
const int ID_FILE_EXPORT_TO_RTF = 576;
const int ID_EXPORT_GLOSSES = 577;
const int ID_EXPORT_FREE_TRANS = 578;
const int ID_FILE_EXPORT_KB = 579;
const int ID_IMPORT_TO_KB = 580;
const int ID_ADVANCED_MENU = 581;
const int ID_ADVANCED_ENABLEGLOSSING = 582;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 583;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 584;
const int ID_ADVANCED_DELAY = 585;
const int ID_ADVANCED_BOOKMODE = 586;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 587;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 588;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 589;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 590;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 591;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 592;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 593;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 594;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 595;
const int ID_LAYOUT_MENU = 596;
const int ID_ALIGNMENT = 597;
const int ID_HELP_MENU = 598;
const int ID_ONLINE_HELP = 599;
const int ID_USER_FORUM = 600;
const int ID_HELP_USE_TOOLTIPS = 601;
const int ID_ADMINISTRATOR_MENU = 602;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 603;
const int ID_LOCK_CUSTOM_LOCATION = 604;
const int ID_UNLOCK_CUSTOM_LOCATION = 605;
const int ID_LOCAL_WORK_FOLDER_MENU = 606;
