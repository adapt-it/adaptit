...
const int ID_BUTTON_PEEK = 498;
const int ID_BUTTON_PEEK_RTL = 499;
wxSizer *MoveOrCopyFilesOrFoldersFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXT_MSG1 = 500;
const int ID_TEXTCTRL_SOURCE_FILE_DETAILS = 501;
const int ID_TEXTCTRL_DESTINATION_FILE_DETAILS = 502;
const int ID_RADIOBUTTON_REPLACE = 503;
const int ID_RADIOBUTTON_NO_COPY = 504;
const int ID_RADIOBUTTON_COPY_AND_RENAME = 505;
const int ID_TEXT_MODIFY_NAME = 506;
const int ID_CHECKBOX_HANDLE_SAME = 507;
wxSizer *FilenameConflictFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_LISTBOX_UPDATED = 508;
const int ID_TEXTCTRL_INFO_SOURCE = 509;
const int ID_TEXTCTRL_INFO_REFS = 510;
const int ID_LISTBOX_MATCHED = 511;
const int ID_BUTTON_UPDATE = 512;
const int ID_TEXTCTRL_LOCAL_SEARCH = 513;
const int ID_BUTTON_FIND_NEXT = 514;
const int ID_TEXTCTRL_EDITBOX = 515;
const int ID_BUTTON_RESTORE = 516;
const int ID_BUTTON_REMOVE_UPDATE = 517;
wxSizer *KBEditSearchFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_STATICTEXT_SCROLL_LIST = 518;
const int ID_LIST_LANGUAGE_CODES_NAMES = 519;
const int ID_STATICTEXT_SEARCH_FOR_LANG_NAME = 520;
const int ID_TEXTCTRL_SEARCH_LANG_NAME = 521;
const int ID_BUTTON_USE_SEL_AS_SRC = 522;
const int ID_BUTTON_USE_SEL_AS_TGT = 523;
const int ID_SRC_LANGUAGE_CODE = 524;
const int ID_TEXTCTRL_SRC_LANG_CODE = 525;
...
const int ID_TEXTCTRL_PEEKMSG = 528;
const int ID_TEXTCTRL_LINES100 = 529;
wxSizer *PeekAtFileFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

// Declare menubar functions

const int ID_FILE_MENU = 530;
const int ID_SAVE_AS = 531;
const int ID_FILE_PACK_DOC = 532;
const int ID_FILE_UNPACK_DOC = 533;
const int ID_MENU = 534;
const int ID_FILE_STARTUP_WIZARD = 535;
const int ID_FILE_CLOSEKB = 536;
const int ID_FILE_CHANGEFOLDER = 537;
const int ID_FILE_SAVEKB = 538;
const int ID_FILE_BACKUP_KB = 539;
const int ID_FILE_RESTORE_KB = 540;
const int ID_EDIT_MENU = 541;
const int ID_EDIT_CUT = 542;
const int ID_EDIT_COPY = 543;
const int ID_EDIT_PASTE = 544;
const int ID_GO_TO = 545;
const int ID_EDIT_SOURCE_TEXT = 546;
const int ID_EDIT_CONSISTENCY_CHECK = 547;
const int ID_EDIT_MOVE_NOTE_FORWARD = 548;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 549;
const int ID_VIEW_MENU = 550;
const int ID_VIEW_TOOLBAR = 551;
const int ID_VIEW_STATUS_BAR = 552;
const int ID_VIEW_COMPOSE_BAR = 553;
const int ID_COPY_SOURCE = 554;
const int ID_MARKER_WRAPS_STRIP = 555;
const int ID_UNITS = 556;
const int ID_CHANGE_INTERFACE_LANGUAGE = 557;
const int ID_TOOLS_MENU = 558;
const int ID_TOOLS_DEFINE_CC = 559;
const int ID_UNLOAD_CC_TABLES = 560;
const int ID_USE_CC = 561;
const int ID_ACCEPT_CHANGES = 562;
const int ID_TOOLS_DEFINE_SILCONVERTER = 563;
const int ID_USE_SILCONVERTER = 564;
const int ID_TOOLS_KB_EDITOR = 565;
const int ID_TOOLS_AUTO_CAPITALIZATION = 566;
const int ID_RETRANS_REPORT = 567;
const int ID_TOOLS_SPLIT_DOC = 568;
const int ID_TOOLS_JOIN_DOCS = 569;
const int ID_TOOLS_MOVE_DOC = 570;
const int ID_EXPORT_IMPORT_MENU = 571;
const int ID_FILE_EXPORT_SOURCE = 572;
const int ID_FILE_EXPORT = 573;
const int ID_FILE_EXPORT_TO_RTF = 574;
const int ID_EXPORT_GLOSSES = 575;
const int ID_EXPORT_FREE_TRANS = 576;
const int ID_FILE_EXPORT_KB = 577;
const int ID_IMPORT_TO_KB = 578;
const int ID_ADVANCED_MENU = 579;
const int ID_ADVANCED_ENABLEGLOSSING = 580;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 581;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 582;
const int ID_ADVANCED_DELAY = 583;
const int ID_ADVANCED_BOOKMODE = 584;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 585;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 586;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 587;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 588;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 589;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 590;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 591;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 592;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 593;
const int ID_LAYOUT_MENU = 594;
const int ID_ALIGNMENT = 595;
const int ID_HELP_MENU = 596;
const int ID_ONLINE_HELP = 597;
const int ID_USER_FORUM = 598;
const int ID_HELP_USE_TOOLTIPS = 599;
const int ID_ADMINISTRATOR_MENU = 600;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 601;
const int ID_LOCK_CUSTOM_LOCATION = 602;
const int ID_UNLOCK_CUSTOM_LOCATION = 603;
const int ID_LOCAL_WORK_FOLDER_MENU = 604;
const int ID_SET_PASSWORD_MENU = 605;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 606;
const int ID_SOURCE_DATA_FOLDER = 607;
