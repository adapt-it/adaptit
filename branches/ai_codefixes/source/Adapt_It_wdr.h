...
const int ID_BUTTON_RENAME = 492;
const int ID_BUTTON_DELETE = 493;
...
const int ID_TEXTCTRL_TGT_LANG_CODE = 521;
wxSizer *LanguageCodesDlgFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

// Declare menubar functions

const int ID_FILE_MENU = 522;
const int ID_SAVE_AS = 523;
const int ID_FILE_PACK_DOC = 524;
const int ID_FILE_UNPACK_DOC = 525;
const int ID_MENU = 526;
const int ID_FILE_STARTUP_WIZARD = 527;
const int ID_FILE_CLOSEKB = 528;
const int ID_FILE_CHANGEFOLDER = 529;
const int ID_FILE_SAVEKB = 530;
const int ID_FILE_BACKUP_KB = 531;
const int ID_FILE_RESTORE_KB = 532;
const int ID_EDIT_MENU = 533;
const int ID_EDIT_CUT = 534;
const int ID_EDIT_COPY = 535;
const int ID_EDIT_PASTE = 536;
const int ID_GO_TO = 537;
const int ID_EDIT_SOURCE_TEXT = 538;
const int ID_EDIT_CONSISTENCY_CHECK = 539;
const int ID_EDIT_MOVE_NOTE_FORWARD = 540;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 541;
const int ID_VIEW_MENU = 542;
const int ID_VIEW_TOOLBAR = 543;
const int ID_VIEW_STATUS_BAR = 544;
const int ID_VIEW_COMPOSE_BAR = 545;
const int ID_COPY_SOURCE = 546;
const int ID_MARKER_WRAPS_STRIP = 547;
const int ID_UNITS = 548;
const int ID_CHANGE_INTERFACE_LANGUAGE = 549;
const int ID_TOOLS_MENU = 550;
const int ID_TOOLS_DEFINE_CC = 551;
const int ID_UNLOAD_CC_TABLES = 552;
const int ID_USE_CC = 553;
const int ID_ACCEPT_CHANGES = 554;
const int ID_TOOLS_DEFINE_SILCONVERTER = 555;
const int ID_USE_SILCONVERTER = 556;
const int ID_TOOLS_KB_EDITOR = 557;
const int ID_TOOLS_AUTO_CAPITALIZATION = 558;
const int ID_RETRANS_REPORT = 559;
const int ID_TOOLS_SPLIT_DOC = 560;
const int ID_TOOLS_JOIN_DOCS = 561;
const int ID_TOOLS_MOVE_DOC = 562;
const int ID_EXPORT_IMPORT_MENU = 563;
const int ID_FILE_EXPORT_SOURCE = 564;
const int ID_FILE_EXPORT = 565;
const int ID_FILE_EXPORT_TO_RTF = 566;
const int ID_EXPORT_GLOSSES = 567;
const int ID_EXPORT_FREE_TRANS = 568;
const int ID_FILE_EXPORT_KB = 569;
const int ID_IMPORT_TO_KB = 570;
const int ID_ADVANCED_MENU = 571;
const int ID_ADVANCED_ENABLEGLOSSING = 572;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 573;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 574;
const int ID_ADVANCED_DELAY = 575;
const int ID_ADVANCED_BOOKMODE = 576;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 577;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 578;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 579;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 580;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 581;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 582;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 583;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 584;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 585;
const int ID_LAYOUT_MENU = 586;
const int ID_ALIGNMENT = 587;
const int ID_HELP_MENU = 588;
const int ID_ONLINE_HELP = 589;
const int ID_USER_FORUM = 590;
const int ID_HELP_USE_TOOLTIPS = 591;
const int ID_ADMINISTRATOR_MENU = 592;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 593;
const int ID_LOCK_CUSTOM_LOCATION = 594;
const int ID_UNLOCK_CUSTOM_LOCATION = 595;
const int ID_LOCAL_WORK_FOLDER_MENU = 596;
const int ID_SET_PASSWORD_MENU = 597;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 598;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_CREATE_NOTE = 599;
const int ID_BUTTON_PREV_NOTE = 600;
const int ID_BUTTON_NEXT_NOTE = 601;
const int ID_BUTTON_DELETE_ALL_NOTES = 602;
const int ID_BUTTON_RESPECTING_BDRY = 603;
const int ID_BUTTON_SHOWING_PUNCT = 604;
const int ID_BUTTON_TO_END = 605;
const int ID_BUTTON_TO_START = 606;
const int ID_BUTTON_STEP_DOWN = 607;
const int ID_BUTTON_STEP_UP = 608;
const int ID_BUTTON_BACK = 609;
const int ID_BUTTON_MERGE = 610;
const int ID_BUTTON_RETRANSLATION = 611;
const int ID_BUTTON_EDIT_RETRANSLATION = 612;
const int ID_REMOVE_RETRANSLATION = 613;
const int ID_BUTTON_NULL_SRC = 614;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 615;
const int ID_BUTTON_CHOOSE_TRANSLATION = 616;
const int ID_SHOWING_ALL = 617;
const int ID_BUTTON_EARLIER_TRANSLATION = 618;
const int ID_BUTTON_NO_PUNCT_COPY = 619;
...
const int ID_BITMAP_FOLDERAI = 620;
const int ID_BITMAP_FILEAI = 621;
const int ID_BITMAP_EMPTY_FOLDER = 622;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 623;
const int ID_BUTTON_HIDING_PUNCT = 624;
const int ID_SHOWING_TGT = 625;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 626;
