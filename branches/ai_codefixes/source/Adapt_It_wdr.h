...
const int ID_TEXTCTRL_NEW_DOC_NAME = 532;
const int ID_TEXTCTRL_BOTTOM_MSG = 533;
wxSizer *NewDocFromSourceDataFolderFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

// Declare menubar functions

const int ID_FILE_MENU = 534;
const int ID_SAVE_AS = 535;
const int ID_FILE_PACK_DOC = 536;
const int ID_FILE_UNPACK_DOC = 537;
const int ID_MENU = 538;
const int ID_FILE_STARTUP_WIZARD = 539;
const int ID_FILE_CLOSEKB = 540;
const int ID_FILE_CHANGEFOLDER = 541;
const int ID_FILE_SAVEKB = 542;
const int ID_FILE_BACKUP_KB = 543;
const int ID_FILE_RESTORE_KB = 544;
const int ID_EDIT_MENU = 545;
const int ID_EDIT_CUT = 546;
const int ID_EDIT_COPY = 547;
const int ID_EDIT_PASTE = 548;
const int ID_GO_TO = 549;
const int ID_EDIT_SOURCE_TEXT = 550;
const int ID_EDIT_CONSISTENCY_CHECK = 551;
const int ID_EDIT_MOVE_NOTE_FORWARD = 552;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 553;
const int ID_VIEW_MENU = 554;
const int ID_VIEW_TOOLBAR = 555;
const int ID_VIEW_STATUS_BAR = 556;
const int ID_VIEW_COMPOSE_BAR = 557;
const int ID_COPY_SOURCE = 558;
const int ID_MARKER_WRAPS_STRIP = 559;
const int ID_UNITS = 560;
const int ID_CHANGE_INTERFACE_LANGUAGE = 561;
const int ID_TOOLS_MENU = 562;
const int ID_TOOLS_DEFINE_CC = 563;
const int ID_UNLOAD_CC_TABLES = 564;
const int ID_USE_CC = 565;
const int ID_ACCEPT_CHANGES = 566;
const int ID_TOOLS_DEFINE_SILCONVERTER = 567;
const int ID_USE_SILCONVERTER = 568;
const int ID_TOOLS_KB_EDITOR = 569;
const int ID_TOOLS_AUTO_CAPITALIZATION = 570;
const int ID_RETRANS_REPORT = 571;
const int ID_TOOLS_SPLIT_DOC = 572;
const int ID_TOOLS_JOIN_DOCS = 573;
const int ID_TOOLS_MOVE_DOC = 574;
const int ID_EXPORT_IMPORT_MENU = 575;
const int ID_FILE_EXPORT_SOURCE = 576;
const int ID_FILE_EXPORT = 577;
const int ID_FILE_EXPORT_TO_RTF = 578;
const int ID_EXPORT_GLOSSES = 579;
const int ID_EXPORT_FREE_TRANS = 580;
const int ID_FILE_EXPORT_KB = 581;
const int ID_IMPORT_TO_KB = 582;
const int ID_ADVANCED_MENU = 583;
const int ID_ADVANCED_ENABLEGLOSSING = 584;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 585;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 586;
const int ID_ADVANCED_DELAY = 587;
const int ID_ADVANCED_BOOKMODE = 588;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 589;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 590;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 591;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 592;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 593;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 594;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 595;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 596;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 597;
const int ID_LAYOUT_MENU = 598;
const int ID_ALIGNMENT = 599;
const int ID_HELP_MENU = 600;
const int ID_ONLINE_HELP = 601;
const int ID_USER_FORUM = 602;
const int ID_HELP_USE_TOOLTIPS = 603;
const int ID_ADMINISTRATOR_MENU = 604;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 605;
const int ID_LOCK_CUSTOM_LOCATION = 606;
const int ID_UNLOCK_CUSTOM_LOCATION = 607;
const int ID_LOCAL_WORK_FOLDER_MENU = 608;
const int ID_SET_PASSWORD_MENU = 609;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 610;
const int ID_SOURCE_DATA_FOLDER = 611;
