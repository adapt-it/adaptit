...
const int ID_FILE_EXPORT_KB = 583;
const int ID_IMPORT_TO_KB = 584;
const int ID_ADVANCED_MENU = 585;
const int ID_ADVANCED_ENABLEGLOSSING = 586;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 587;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 588;
const int ID_ADVANCED_DELAY = 589;
const int ID_ADVANCED_BOOKMODE = 590;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 591;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 592;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 593;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 594;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 595;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 596;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 597;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 598;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 599;
const int ID_LAYOUT_MENU = 600;
const int ID_ALIGNMENT = 601;
const int ID_HELP_MENU = 602;
const int ID_ONLINE_HELP = 603;
const int ID_USER_FORUM = 604;
const int ID_HELP_USE_TOOLTIPS = 605;
const int ID_ADMINISTRATOR_MENU = 606;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 607;
const int ID_LOCK_CUSTOM_LOCATION = 608;
const int ID_UNLOCK_CUSTOM_LOCATION = 609;
const int ID_LOCAL_WORK_FOLDER_MENU = 610;
const int ID_SET_PASSWORD_MENU = 611;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 612;
const int ID_SOURCE_DATA_FOLDER = 613;
const int ID_EXPORT_DATA_FOLDER = 614;
const int ID_EDIT_USER_MENU_SETTINGS_PROFILE = 615;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_CREATE_NOTE = 616;
const int ID_BUTTON_PREV_NOTE = 617;
const int ID_BUTTON_NEXT_NOTE = 618;
const int ID_BUTTON_DELETE_ALL_NOTES = 619;
const int ID_BUTTON_RESPECTING_BDRY = 620;
const int ID_BUTTON_SHOWING_PUNCT = 621;
const int ID_BUTTON_TO_END = 622;
const int ID_BUTTON_TO_START = 623;
const int ID_BUTTON_STEP_DOWN = 624;
const int ID_BUTTON_STEP_UP = 625;
const int ID_BUTTON_BACK = 626;
const int ID_BUTTON_MERGE = 627;
const int ID_BUTTON_RETRANSLATION = 628;
const int ID_BUTTON_EDIT_RETRANSLATION = 629;
const int ID_REMOVE_RETRANSLATION = 630;
const int ID_BUTTON_NULL_SRC = 631;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 632;
const int ID_BUTTON_CHOOSE_TRANSLATION = 633;
const int ID_SHOWING_ALL = 634;
const int ID_BUTTON_EARLIER_TRANSLATION = 635;
const int ID_BUTTON_NO_PUNCT_COPY = 636;
...
const int ID_BITMAP_FOLDERAI = 637;
const int ID_BITMAP_FILEAI = 638;
const int ID_BITMAP_EMPTY_FOLDER = 639;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 640;
const int ID_BUTTON_HIDING_PUNCT = 641;
const int ID_SHOWING_TGT = 642;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 643;
