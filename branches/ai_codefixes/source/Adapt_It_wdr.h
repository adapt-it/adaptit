...
const int ID_TEXTCTRL_TOP_MSG = 530;
const int ID_TEXTCTRL_INSTRUCTIONS = 531;
const int ID_LISTBOX_LOADABLES_FILENAMES = 532;
wxSizer *NewDocFromSourceDataFolderFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

// Declare menubar functions

const int ID_FILE_MENU = 533;
const int ID_SAVE_AS = 534;
const int ID_FILE_PACK_DOC = 535;
const int ID_FILE_UNPACK_DOC = 536;
const int ID_MENU = 537;
const int ID_FILE_STARTUP_WIZARD = 538;
const int ID_FILE_CLOSEKB = 539;
const int ID_FILE_CHANGEFOLDER = 540;
const int ID_FILE_SAVEKB = 541;
const int ID_FILE_BACKUP_KB = 542;
const int ID_FILE_RESTORE_KB = 543;
const int ID_EDIT_MENU = 544;
const int ID_EDIT_CUT = 545;
const int ID_EDIT_COPY = 546;
const int ID_EDIT_PASTE = 547;
const int ID_GO_TO = 548;
const int ID_EDIT_SOURCE_TEXT = 549;
const int ID_EDIT_CONSISTENCY_CHECK = 550;
const int ID_EDIT_MOVE_NOTE_FORWARD = 551;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 552;
const int ID_VIEW_MENU = 553;
const int ID_VIEW_TOOLBAR = 554;
const int ID_VIEW_STATUS_BAR = 555;
const int ID_VIEW_COMPOSE_BAR = 556;
const int ID_COPY_SOURCE = 557;
const int ID_MARKER_WRAPS_STRIP = 558;
const int ID_UNITS = 559;
const int ID_CHANGE_INTERFACE_LANGUAGE = 560;
const int ID_TOOLS_MENU = 561;
const int ID_TOOLS_DEFINE_CC = 562;
const int ID_UNLOAD_CC_TABLES = 563;
const int ID_USE_CC = 564;
const int ID_ACCEPT_CHANGES = 565;
const int ID_TOOLS_DEFINE_SILCONVERTER = 566;
const int ID_USE_SILCONVERTER = 567;
const int ID_TOOLS_KB_EDITOR = 568;
const int ID_TOOLS_AUTO_CAPITALIZATION = 569;
const int ID_RETRANS_REPORT = 570;
const int ID_TOOLS_SPLIT_DOC = 571;
const int ID_TOOLS_JOIN_DOCS = 572;
const int ID_TOOLS_MOVE_DOC = 573;
const int ID_EXPORT_IMPORT_MENU = 574;
const int ID_FILE_EXPORT_SOURCE = 575;
const int ID_FILE_EXPORT = 576;
const int ID_FILE_EXPORT_TO_RTF = 577;
const int ID_EXPORT_GLOSSES = 578;
const int ID_EXPORT_FREE_TRANS = 579;
const int ID_FILE_EXPORT_KB = 580;
const int ID_IMPORT_TO_KB = 581;
const int ID_ADVANCED_MENU = 582;
const int ID_ADVANCED_ENABLEGLOSSING = 583;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 584;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 585;
const int ID_ADVANCED_DELAY = 586;
const int ID_ADVANCED_BOOKMODE = 587;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 588;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 589;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 590;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 591;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 592;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 593;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 594;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 595;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 596;
const int ID_LAYOUT_MENU = 597;
const int ID_ALIGNMENT = 598;
const int ID_HELP_MENU = 599;
const int ID_ONLINE_HELP = 600;
const int ID_USER_FORUM = 601;
const int ID_HELP_USE_TOOLTIPS = 602;
const int ID_ADMINISTRATOR_MENU = 603;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 604;
const int ID_LOCK_CUSTOM_LOCATION = 605;
const int ID_UNLOCK_CUSTOM_LOCATION = 606;
const int ID_LOCAL_WORK_FOLDER_MENU = 607;
const int ID_SET_PASSWORD_MENU = 608;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 609;
const int ID_SOURCE_DATA_FOLDER = 610;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_CREATE_NOTE = 611;
const int ID_BUTTON_PREV_NOTE = 612;
const int ID_BUTTON_NEXT_NOTE = 613;
const int ID_BUTTON_DELETE_ALL_NOTES = 614;
const int ID_BUTTON_RESPECTING_BDRY = 615;
const int ID_BUTTON_SHOWING_PUNCT = 616;
const int ID_BUTTON_TO_END = 617;
const int ID_BUTTON_TO_START = 618;
const int ID_BUTTON_STEP_DOWN = 619;
const int ID_BUTTON_STEP_UP = 620;
const int ID_BUTTON_BACK = 621;
const int ID_BUTTON_MERGE = 622;
const int ID_BUTTON_RETRANSLATION = 623;
const int ID_BUTTON_EDIT_RETRANSLATION = 624;
const int ID_REMOVE_RETRANSLATION = 625;
const int ID_BUTTON_NULL_SRC = 626;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 627;
const int ID_BUTTON_CHOOSE_TRANSLATION = 628;
const int ID_SHOWING_ALL = 629;
const int ID_BUTTON_EARLIER_TRANSLATION = 630;
const int ID_BUTTON_NO_PUNCT_COPY = 631;
...
const int ID_BITMAP_FOLDERAI = 632;
const int ID_BITMAP_FILEAI = 633;
const int ID_BITMAP_EMPTY_FOLDER = 634;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 635;
const int ID_BUTTON_HIDING_PUNCT = 636;
const int ID_SHOWING_TGT = 637;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 638;
