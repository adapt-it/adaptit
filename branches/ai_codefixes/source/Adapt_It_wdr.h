...
const int ID_TEXTCTRL_AS_STATIC_FILTERPAGE = 529;
const int IDC_LIST_SFMS_PROJ = 530;
...
const int ID_CHECKBOX_LET_DEVS_KNOW_AI_USAGE = 549;
const int ID_BUTTON_VIEW_USAGE_LOG = 550;
const int ID_TEXT_AI_VERSION = 551;
const int ID_TEXT_RELEASE_DATE = 552;
const int ID_TEXT_DATA_TYPE = 553;
const int ID_TEXT_FREE_MEMORY = 554;
const int ID_TEXT_SYS_LOCALE = 555;
const int ID_TEXT_INTERFACE_LANGUAGE = 556;
const int ID_TEXT_SYS_ENCODING = 557;
const int ID_TEXT_SYS_LAYOUT_DIR = 558;
const int ID_TEXT_WXWIDGETS_VERSION = 559;
const int ID_TEXT_OS_VERSION = 560;
const int ID_BUTTON_SAVE_REPORT_AS_TEXT_FILE = 561;
const int ID_BUTTON_LOAD_SAVED_REPORT = 562;
const int ID_RADIOBUTTON_SEND_DIRECTLY_FROM_AI = 563;
const int ID_RADIOBUTTON_SEND_TO_MY_EMAIL = 564;
const int ID_BUTTON_ATTACH_PACKED_DOC = 565;
const int ID_BUTTON_SEND_NOW = 566;
wxSizer *EmailReportDlgFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

// Declare menubar functions

const int ID_FILE_MENU = 567;
const int ID_SAVE_AS = 568;
const int ID_FILE_PACK_DOC = 569;
const int ID_FILE_UNPACK_DOC = 570;
const int ID_MENU = 571;
const int ID_FILE_STARTUP_WIZARD = 572;
const int ID_FILE_CLOSEKB = 573;
const int ID_FILE_CHANGEFOLDER = 574;
const int ID_FILE_SAVEKB = 575;
const int ID_FILE_BACKUP_KB = 576;
const int ID_FILE_RESTORE_KB = 577;
const int ID_EDIT_MENU = 578;
const int ID_EDIT_CUT = 579;
const int ID_EDIT_COPY = 580;
const int ID_EDIT_PASTE = 581;
const int ID_GO_TO = 582;
const int ID_EDIT_SOURCE_TEXT = 583;
const int ID_EDIT_CONSISTENCY_CHECK = 584;
const int ID_EDIT_MOVE_NOTE_FORWARD = 585;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 586;
const int ID_VIEW_MENU = 587;
const int ID_VIEW_TOOLBAR = 588;
const int ID_VIEW_STATUS_BAR = 589;
const int ID_VIEW_COMPOSE_BAR = 590;
const int ID_COPY_SOURCE = 591;
const int ID_MARKER_WRAPS_STRIP = 592;
const int ID_UNITS = 593;
const int ID_CHANGE_INTERFACE_LANGUAGE = 594;
const int ID_TOOLS_MENU = 595;
const int ID_TOOLS_DEFINE_CC = 596;
const int ID_UNLOAD_CC_TABLES = 597;
const int ID_USE_CC = 598;
const int ID_ACCEPT_CHANGES = 599;
const int ID_TOOLS_DEFINE_SILCONVERTER = 600;
const int ID_USE_SILCONVERTER = 601;
const int ID_TOOLS_KB_EDITOR = 602;
const int ID_TOOLS_AUTO_CAPITALIZATION = 603;
const int ID_RETRANS_REPORT = 604;
const int ID_TOOLS_SPLIT_DOC = 605;
const int ID_TOOLS_JOIN_DOCS = 606;
const int ID_TOOLS_MOVE_DOC = 607;
const int ID_EXPORT_IMPORT_MENU = 608;
const int ID_FILE_EXPORT_SOURCE = 609;
const int ID_FILE_EXPORT = 610;
const int ID_FILE_EXPORT_TO_RTF = 611;
const int ID_EXPORT_GLOSSES = 612;
const int ID_EXPORT_FREE_TRANS = 613;
const int ID_EXPORT_OXES = 614;
const int ID_FILE_EXPORT_KB = 615;
const int ID_IMPORT_TO_KB = 616;
const int ID_ADVANCED_MENU = 617;
const int ID_ADVANCED_ENABLEGLOSSING = 618;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 619;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 620;
const int ID_ADVANCED_DELAY = 621;
const int ID_ADVANCED_BOOKMODE = 622;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 623;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 624;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 625;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 626;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 627;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 628;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 629;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 630;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 631;
const int ID_LAYOUT_MENU = 632;
const int ID_ALIGNMENT = 633;
const int ID_HELP_MENU = 634;
const int ID_ONLINE_HELP = 635;
const int ID_REPORT_A_PROBLEM = 636;
const int ID_GIVE_FEEDBACK = 637;
const int ID_HELP_USE_TOOLTIPS = 638;
const int ID_ADMINISTRATOR_MENU = 639;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 640;
const int ID_LOCK_CUSTOM_LOCATION = 641;
const int ID_UNLOCK_CUSTOM_LOCATION = 642;
const int ID_LOCAL_WORK_FOLDER_MENU = 643;
const int ID_SET_PASSWORD_MENU = 644;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 645;
const int ID_SOURCE_DATA_FOLDER = 646;
const int ID_EXPORT_DATA_FOLDER = 647;
const int ID_EDIT_USER_MENU_SETTINGS_PROFILE = 648;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_GUESSER = 649;
const int ID_BUTTON_CREATE_NOTE = 650;
const int ID_BUTTON_PREV_NOTE = 651;
const int ID_BUTTON_NEXT_NOTE = 652;
const int ID_BUTTON_DELETE_ALL_NOTES = 653;
const int ID_BUTTON_RESPECTING_BDRY = 654;
const int ID_BUTTON_SHOWING_PUNCT = 655;
const int ID_BUTTON_TO_END = 656;
const int ID_BUTTON_TO_START = 657;
const int ID_BUTTON_STEP_DOWN = 658;
const int ID_BUTTON_STEP_UP = 659;
const int ID_BUTTON_BACK = 660;
const int ID_BUTTON_MERGE = 661;
const int ID_BUTTON_RETRANSLATION = 662;
const int ID_BUTTON_EDIT_RETRANSLATION = 663;
const int ID_REMOVE_RETRANSLATION = 664;
const int ID_BUTTON_NULL_SRC = 665;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 666;
const int ID_BUTTON_CHOOSE_TRANSLATION = 667;
const int ID_SHOWING_ALL = 668;
const int ID_BUTTON_EARLIER_TRANSLATION = 669;
const int ID_BUTTON_NO_PUNCT_COPY = 670;
...
const int ID_BITMAP_FOLDERAI = 671;
const int ID_BITMAP_FILEAI = 672;
const int ID_BITMAP_EMPTY_FOLDER = 673;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 674;
const int ID_BUTTON_HIDING_PUNCT = 675;
const int ID_SHOWING_TGT = 676;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 677;
