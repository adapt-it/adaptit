...
const int ID_TEXTCTRL_PEEKMSG = 529;
const int ID_TEXTCTRL_LINES100 = 530;
wxSizer *PeekAtFileFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

// Declare menubar functions

const int ID_FILE_MENU = 531;
const int ID_SAVE_AS = 532;
const int ID_FILE_PACK_DOC = 533;
const int ID_FILE_UNPACK_DOC = 534;
const int ID_MENU = 535;
const int ID_FILE_STARTUP_WIZARD = 536;
const int ID_FILE_CLOSEKB = 537;
const int ID_FILE_CHANGEFOLDER = 538;
const int ID_FILE_SAVEKB = 539;
const int ID_FILE_BACKUP_KB = 540;
const int ID_FILE_RESTORE_KB = 541;
const int ID_EDIT_MENU = 542;
const int ID_EDIT_CUT = 543;
const int ID_EDIT_COPY = 544;
const int ID_EDIT_PASTE = 545;
const int ID_GO_TO = 546;
const int ID_EDIT_SOURCE_TEXT = 547;
const int ID_EDIT_CONSISTENCY_CHECK = 548;
const int ID_EDIT_MOVE_NOTE_FORWARD = 549;
const int ID_EDIT_MOVE_NOTE_BACKWARD = 550;
const int ID_VIEW_MENU = 551;
const int ID_VIEW_TOOLBAR = 552;
const int ID_VIEW_STATUS_BAR = 553;
const int ID_VIEW_COMPOSE_BAR = 554;
const int ID_COPY_SOURCE = 555;
const int ID_MARKER_WRAPS_STRIP = 556;
const int ID_UNITS = 557;
const int ID_CHANGE_INTERFACE_LANGUAGE = 558;
const int ID_TOOLS_MENU = 559;
const int ID_TOOLS_DEFINE_CC = 560;
const int ID_UNLOAD_CC_TABLES = 561;
const int ID_USE_CC = 562;
const int ID_ACCEPT_CHANGES = 563;
const int ID_TOOLS_DEFINE_SILCONVERTER = 564;
const int ID_USE_SILCONVERTER = 565;
const int ID_TOOLS_KB_EDITOR = 566;
const int ID_TOOLS_AUTO_CAPITALIZATION = 567;
const int ID_RETRANS_REPORT = 568;
const int ID_TOOLS_SPLIT_DOC = 569;
const int ID_TOOLS_JOIN_DOCS = 570;
const int ID_TOOLS_MOVE_DOC = 571;
const int ID_EXPORT_IMPORT_MENU = 572;
const int ID_FILE_EXPORT_SOURCE = 573;
const int ID_FILE_EXPORT = 574;
const int ID_FILE_EXPORT_TO_RTF = 575;
const int ID_EXPORT_GLOSSES = 576;
const int ID_EXPORT_FREE_TRANS = 577;
const int ID_FILE_EXPORT_KB = 578;
const int ID_IMPORT_TO_KB = 579;
const int ID_ADVANCED_MENU = 580;
const int ID_ADVANCED_ENABLEGLOSSING = 581;
const int ID_ADVANCED_GLOSSING_USES_NAV_FONT = 582;
const int ID_ADVANCED_TRANSFORM_ADAPTATIONS_INTO_GLOSSES = 583;
const int ID_ADVANCED_DELAY = 584;
const int ID_ADVANCED_BOOKMODE = 585;
const int ID_ADVANCED_FREE_TRANSLATION_MODE = 586;
const int ID_ADVANCED_TARGET_TEXT_IS_DEFAULT = 587;
const int ID_ADVANCED_GLOSS_TEXT_IS_DEFAULT = 588;
const int ID_ADVANCED_REMOVE_FILTERED_FREE_TRANSLATIONS = 589;
const int ID_ADVANCED_COLLECT_BACKTRANSLATIONS = 590;
const int ID_ADVANCED_REMOVE_FILTERED_BACKTRANSLATIONS = 591;
const int ID_ADVANCED_USETRANSLITERATIONMODE = 592;
const int ID_ADVANCED_SENDSYNCHRONIZEDSCROLLINGMESSAGES = 593;
const int ID_ADVANCED_RECEIVESYNCHRONIZEDSCROLLINGMESSAGES = 594;
const int ID_LAYOUT_MENU = 595;
const int ID_ALIGNMENT = 596;
const int ID_HELP_MENU = 597;
const int ID_ONLINE_HELP = 598;
const int ID_USER_FORUM = 599;
const int ID_HELP_USE_TOOLTIPS = 600;
const int ID_ADMINISTRATOR_MENU = 601;
const int ID_CUSTOM_WORK_FOLDER_LOCATION = 602;
const int ID_LOCK_CUSTOM_LOCATION = 603;
const int ID_UNLOCK_CUSTOM_LOCATION = 604;
const int ID_LOCAL_WORK_FOLDER_MENU = 605;
const int ID_SET_PASSWORD_MENU = 606;
const int ID_MOVE_OR_COPY_FOLDERS_OR_FILES = 607;
wxMenuBar *AIMenuBarFunc();

// Declare toolbar functions

const int ID_BUTTON_CREATE_NOTE = 608;
const int ID_BUTTON_PREV_NOTE = 609;
const int ID_BUTTON_NEXT_NOTE = 610;
const int ID_BUTTON_DELETE_ALL_NOTES = 611;
const int ID_BUTTON_RESPECTING_BDRY = 612;
const int ID_BUTTON_SHOWING_PUNCT = 613;
const int ID_BUTTON_TO_END = 614;
const int ID_BUTTON_TO_START = 615;
const int ID_BUTTON_STEP_DOWN = 616;
const int ID_BUTTON_STEP_UP = 617;
const int ID_BUTTON_BACK = 618;
const int ID_BUTTON_MERGE = 619;
const int ID_BUTTON_RETRANSLATION = 620;
const int ID_BUTTON_EDIT_RETRANSLATION = 621;
const int ID_REMOVE_RETRANSLATION = 622;
const int ID_BUTTON_NULL_SRC = 623;
const int ID_BUTTON_REMOVE_NULL_SRCPHRASE = 624;
const int ID_BUTTON_CHOOSE_TRANSLATION = 625;
const int ID_SHOWING_ALL = 626;
const int ID_BUTTON_EARLIER_TRANSLATION = 627;
const int ID_BUTTON_NO_PUNCT_COPY = 628;
...
const int ID_BITMAP_FOLDERAI = 629;
const int ID_BITMAP_FILEAI = 630;
const int ID_BITMAP_EMPTY_FOLDER = 631;
wxBitmap AIMainFrameIcons( size_t index );

const int ID_BUTTON_IGNORING_BDRY = 632;
const int ID_BUTTON_HIDING_PUNCT = 633;
const int ID_SHOWING_TGT = 634;
const int ID_BUTTON_ENABLE_PUNCT_COPY = 635;
