...
// BEW 4May10
//#include "..\..\..\..\..\Program Files\Microsoft SDKs\Windows\v6.0A\include\rpcDce.h" // GUID is in guiddef.h in same folder

namespace kashmir {

// BEW 4May10 UUID not defined. Try using Microsoft's definition of GUID and UUID
