		...
		*/
		...
		if (gpApp->m_bSingleStep)
		{
			...
			*/
			...
			int nOldStripIndex = gpApp->m_pActivePile->GetStrip()->GetStripIndex(); // TODO, check if needed for refactor ??
